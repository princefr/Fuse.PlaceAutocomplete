...
namespace g{namespace Fuse{namespace Animations{struct Easing__ElasticInOutImpl;}}}
...
struct Easing__ElasticInOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__ElasticInOutImpl* New1();
};
// }
