...
namespace g{namespace Fuse{namespace Animations{struct Easing__CircularOutImpl;}}}
...
struct Easing__CircularOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__CircularOutImpl* New1();
};
// }
