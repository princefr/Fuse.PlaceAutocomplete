...
namespace g{namespace Fuse{namespace Animations{struct Easing__QuinticInImpl;}}}
...
struct Easing__QuinticInImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__QuinticInImpl* New1();
};
// }
