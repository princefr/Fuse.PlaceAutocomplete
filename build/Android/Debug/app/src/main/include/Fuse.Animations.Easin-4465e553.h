...
namespace g{namespace Fuse{namespace Animations{struct Easing__SinusoidalInImpl;}}}
...
struct Easing__SinusoidalInImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__SinusoidalInImpl* New1();
};
// }
