...
namespace g{namespace Fuse{namespace Animations{struct Easing__SinusoidalOutImpl;}}}
...
struct Easing__SinusoidalOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__SinusoidalOutImpl* New1();
};
// }
