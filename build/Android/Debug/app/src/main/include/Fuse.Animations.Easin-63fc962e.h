...
namespace g{namespace Fuse{namespace Animations{struct Easing__CubicInOutImpl;}}}
...
struct Easing__CubicInOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__CubicInOutImpl* New1();
};
// }
