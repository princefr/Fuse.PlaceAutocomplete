...
namespace g{namespace Fuse{namespace Animations{struct Easing__QuadraticOutImpl;}}}
...
struct Easing__QuadraticOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__QuadraticOutImpl* New1();
};
// }
