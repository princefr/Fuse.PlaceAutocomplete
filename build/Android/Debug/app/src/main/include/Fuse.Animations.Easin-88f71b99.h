...
namespace g{namespace Fuse{namespace Animations{struct Easing__QuarticInOutImpl;}}}
...
struct Easing__QuarticInOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__QuarticInOutImpl* New1();
};
// }
