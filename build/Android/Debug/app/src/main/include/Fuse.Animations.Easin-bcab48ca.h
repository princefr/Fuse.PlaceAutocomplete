...
namespace g{namespace Fuse{namespace Animations{struct Easing__QuadraticInImpl;}}}
...
struct Easing__QuadraticInImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__QuadraticInImpl* New1();
};
// }
