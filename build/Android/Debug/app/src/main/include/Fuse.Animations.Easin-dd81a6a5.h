...
namespace g{namespace Fuse{namespace Animations{struct Easing__SinusoidalInOutImpl;}}}
...
struct Easing__SinusoidalInOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__SinusoidalInOutImpl* New1();
};
// }
