...
namespace g{namespace Fuse{namespace Animations{struct Easing__QuarticOutImpl;}}}
...
struct Easing__QuarticOutImpl : ::g::Fuse::Animations::Easing
{
    void ctor_1();
    static Easing__QuarticOutImpl* New1();
};
// }
