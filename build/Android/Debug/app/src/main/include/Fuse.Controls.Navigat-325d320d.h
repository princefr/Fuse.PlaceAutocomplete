// This file was generated based on /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.2/.uno/ux13/Fuse.Controls.NavigationInternal.NavEnterHorizontal.g.uno.
...
namespace g{namespace Fuse{namespace Controls{namespace NavigationInternal{struct NavEnterHorizontal;}}}}
...
struct NavEnterHorizontal : ::g::Fuse::Triggers::Transition
{
    void ctor_6();
    void InitializeUX();
    static NavEnterHorizontal* New3();
};
// }
