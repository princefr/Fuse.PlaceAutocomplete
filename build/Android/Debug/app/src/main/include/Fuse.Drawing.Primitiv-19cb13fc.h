// This file was generated based on /usr/local/share/uno/Packages/Fuse.Drawing.Primitives/1.4.2/Circle.uno.
...
struct OneLimitCoverage : ::g::Fuse::Drawing::Primitives::LimitCoverage
{
    void ctor_1();
    static OneLimitCoverage* New1();
};
// }
