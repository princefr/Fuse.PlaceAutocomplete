// This file was generated based on /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Node.DataContext.uno.
...
struct Node__DataFinder_type : uType
{
    ...
    void(*fp_Resolve)(::g::Fuse::Node__DataFinder*, uObject*, uObject*);
};
