// This file was generated based on /usr/local/share/uno/Packages/Fuse.Elements/1.4.2/Resources/ImageSource.uno.
...
struct ImageSource_type : uType
{
    ...
    void(*fp_get_Orientation)(::g::Fuse::Resources::ImageSource*, int*);
