// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/ThreadWorker.Mirror.uno.
...
struct ThreadWorker_type : uType
{
    ...
    ::g::Fuse::Scripting::IMirror interface3;
};
