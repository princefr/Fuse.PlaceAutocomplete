...
namespace g{struct FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text;}
...
struct FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static FuseControlsPrimitives_accessor_Fuse_Controls_ButtonBase_Text* New1();
};
// }
