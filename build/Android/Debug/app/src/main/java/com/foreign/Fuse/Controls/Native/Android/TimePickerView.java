...
public class TimePickerView
{
    ...
    {
        return new android.widget.TimePicker(com.apps.fuse.placeautocomplete.fuseplaceautocomplete.GetRootActivity());
    }
    
    public static long GetTimeInMsSince1970InUtc230(final UnoObject _this, final Object timePickerHandle)
    {
    ...
    public static void SetIs24HourView231(final UnoObject _this, final Object timePickerHandle,final boolean value)
    {
        android.widget.TimePicker timePicker = (android.widget.TimePicker)timePickerHandle;
    ...
    public static void SetTime232(final UnoObject _this, final Object timePickerHandle,final long msSince1970InUtc)
    {
        java.util.Calendar cal = java.util.Calendar.getInstance(java.util.TimeZone.getTimeZone("UTC"), java.util.Locale.getDefault());
