...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.4.2/Internal/Swiper.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Gestures/1.4.2/Internal/EdgeSwiper.uno
// -------------------------------------------------------------------------
...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Gestures/1.4.2/Internal/Swiper.uno");
