...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/AndroidSystemFont.uno
// ------------------------------------------------------------------------------
...
void AndroidSystemFont::AddFamily(uString* name, uString* language, uString* variant)
{
    bool ret5;
    bool ret6;
    uString* lowerName = ::g::Uno::String::op_Equality(name, NULL) ? uCast<uString*>(NULL, ::TYPES[28/*string*/]) : (uString*)::g::Uno::String::ToLower(uPtr(name));
...
void AndroidSystemFont::EnsureFontsAdded()
{
    if (AndroidSystemFont::_families_ == NULL)
    {
        ...
        AndroidSystemFont::_aliases_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[28/*string*/], AndroidSystemFont__Alias_typeof(), NULL)));
        AndroidSystemFont::_familyNames_ = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::g::Uno::Collections::HashSet_typeof()->MakeType(::TYPES[28/*string*/], NULL)));
        AndroidSystemFont::AddFonts();
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/Blender.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/Curves.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/DrawManager.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/MiniList.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/ObjectList.uno
// -----------------------------------------------------------------------
...
{
    ::TYPES[7] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Internal::AndroidSystemFont__FontDescriptor_typeof(), NULL);
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/SystemFont.uno
// -----------------------------------------------------------------------
...
static void FontFaceDescriptor_build(uType* type)
{
    ...
    ::TYPES[14] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
...
void FontFaceDescriptor__Equals_fn(FontFaceDescriptor* __this, uObject* o, bool* __retval)
{
    ...
    return *__retval = (((f != NULL) && ::g::Uno::String::op_Equality(uPtr(__this->FileSource)->Name, uPtr(uPtr(f)->FileSource)->Name)) && (__this->Index == uPtr(f)->Index)) && ::g::Uno::Collections::EnumerableExtensions::SequenceEqual(::TYPES[10/*Uno.Collections.EnumerableExtensions.SequenceEqual<string>*/], __this->Styles, uPtr(f)->Styles), void();
}
...
void FontFaceDescriptor::ctor_(::g::Uno::UX::FileSource* fileSource, int index)
{
    ...
    Index = index;
    Styles = (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[8/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], uArray::New(::TYPES[9/*string[]*/], 0)));
}
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/FrustumMatrix.uno
// --------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.2/Internal/ImageContainer.uno
// -----------------------------------------------------------------------------
...
static void ImageContainer_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("/usr/local/share/uno/Packages/Fuse.Elements/1.4.2/Internal/ImageContainer.uno");
    ...
    ::TYPES[13] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[16] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ::TYPES[17] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
    ::TYPES[15] = ::g::Uno::IDisposable_typeof();
    ::TYPES[18] = ::g::Fuse::Internal::IImageContainerOwner_typeof();
    ::TYPES[19] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::UX::FileSource_typeof(), NULL);
    ...
    ::TYPES[23] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof(), NULL);
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/RawPointer.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/RectPacker.uno
// -----------------------------------------------------------------------
...
{
    ::TYPES[27] = ::g::Uno::Collections::LinkedList_typeof()->MakeType(::g::Fuse::Internal::SkylineNode_typeof(), NULL);
    type->SetFields(0,
...
// /usr/local/share/uno/Packages/Fuse.Elements/1.4.2/Internal/SizingContainer.uno
// ------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/Statistics.uno
// -----------------------------------------------------------------------
...
{
    return ::g::Fuse::Internal::AndroidSystemFont::Get1(::g::Uno::String::op_Equality(family, NULL) ? uCast<uString*>(NULL, ::TYPES[28/*string*/]) : (uString*)::g::Uno::String::ToLower(uPtr(family)), style, weight);
}
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Internal/VectorUtil.uno
// -----------------------------------------------------------------------
