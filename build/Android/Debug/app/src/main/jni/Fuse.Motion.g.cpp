...
static void DestinationMotionConfig_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Motion/1.4.2/DestinationMotion.uno");
...
// /usr/local/share/uno/Packages/Fuse.Motion/1.4.2/MotionConfig.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Motion/1.4.2/Enums.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Motion/1.4.2/SpringFunction.uno
// ------------------------------------------------------------------
