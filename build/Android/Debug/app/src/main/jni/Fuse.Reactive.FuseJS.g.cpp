...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/Builtins.uno
// ---------------------------------------------------------------------------------
...
static void Builtins_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("fuse-builtins");
    ::STRINGS[8] = uString::Const("Date");
    ::STRINGS[9] = uString::Const("(function(ticks) { return new Date(ticks); })");
    ::STRINGS[10] = uString::Const("Polyfills/Window");
...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* setTimout = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[1/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::setTimeoutde16bf26())->ReadAllText()), ::TYPES[2/*Fuse.Scripting.Function*/]);
    ...
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], uPtr(::g::FuseScriptingJavaScript_bundle::es6promiseminf61a2dae())->ReadAllText());
    context->Evaluate(::STRINGS[3/*"fuse-builti...*/], ::STRINGS[4/*"ES6Promise....*/]);
    ::g::Fuse::Reactive::FuseJS::DiagnosticsImplModule::New2();
    ::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Diagnosticsaebd3a87()))->EvaluateExports(context, ::STRINGS[5/*"FuseJS/Diag...*/]);
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseScriptingJavaScript_bundle::Observable414f1520()))->EvaluateExports(context, ::STRINGS[6/*"FuseJS/Obse...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    EventEmitter = ::g::Fuse::Scripting::EventEmitterModule::GetConstructor(context);
    Date = uCast< ::g::Fuse::Scripting::Function*>(context->Evaluate(::STRINGS[7/*"fuse-builtins"*/], ::STRINGS[8/*"Date"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    DateCtor = uCast< ::g::Fuse::Scripting::Function*>(context->Evaluate(::STRINGS[7/*"fuse-builtins"*/], ::STRINGS[9/*"(function(t...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
    res = NULL;

    if (::g::Uno::UX::Resource::TryFindGlobal(::STRINGS[10/*"Polyfills/W...*/], uDelegate::New(::TYPES[0/*Uno.Predicate<object>*/], (void*)Builtins__IsModule_fn), &res))
        uPtr(uCast< ::g::Fuse::Scripting::Module*>(res, ::TYPES[4/*Fuse.Scripting.Module*/]))->Evaluate1(context, ::STRINGS[10/*"Polyfills/W...*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/Timer.uno
// ------------------------------------------------------------------------------
...
{
    ::STRINGS[11] = uString::Const("func");
    ::STRINGS[12] = uString::Const("args");
    type->SetFields(0,
...
{
    if (func == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[11/*"func"*/]));

    if (args == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[12/*"args"*/]));
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/DiagnosticsImpl.uno
// ----------------------------------------------------------------------------------------
...
{
    ::STRINGS[13] = uString::Const("FuseJS/DiagnosticsImpl");
    ::STRINGS[14] = uString::Const("report");
    ::STRINGS[15] = uString::Const("Report requires 2 arguments");
    ::STRINGS[16] = uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/DiagnosticsImpl.uno");
    ::STRINGS[17] = uString::Const("Report");
...
void DiagnosticsImplModule::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(DiagnosticsImplModule::_instance_ = this, ::STRINGS[13/*"FuseJS/Diag...*/]);
    AddMember(::g::Fuse::Scripting::NativeFunction::New1(::STRINGS[14/*"report"*/], uDelegate::New(::TYPES[5/*Fuse.Scripting.NativeCallback*/], (void*)DiagnosticsImplModule__Report_fn, this)));
}
...
uObject* DiagnosticsImplModule::Report(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Report requ...*/], this, ::STRINGS[16/*"/usr/local/...*/], 30, ::STRINGS[17/*"Report"*/]);
        return NULL;
    }
...
// /usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/Http.uno
// -----------------------------------------------------------------------------
...
{
    ::STRINGS[18] = uString::Const("createRequest");
    ::TYPES[8] = ::g::Fuse::Scripting::Callback_typeof();
...
void Http__FuseJSHttpClient::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(Obj())->Item(::STRINGS[18/*"createRequest"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpClient__CreateRequest_fn, this));
}
...
{
    ::STRINGS[19] = uString::Const("enableCache");
    ::STRINGS[20] = uString::Const("setTimeout");
    ::STRINGS[21] = uString::Const("setResponseType");
    ::STRINGS[22] = uString::Const("getResponseType");
    ::STRINGS[23] = uString::Const("sendAsync");
    ::STRINGS[24] = uString::Const("abort");
    ::STRINGS[25] = uString::Const("setHeader");
    ::STRINGS[26] = uString::Const("getResponseHeader");
    ::STRINGS[27] = uString::Const("getResponseHeaders");
    ::STRINGS[28] = uString::Const("getState");
    ::STRINGS[29] = uString::Const("getResponseStatus");
    ::STRINGS[30] = uString::Const("getResponseReasonPhrase");
    ::STRINGS[31] = uString::Const("getResponseContentString");
    ::STRINGS[32] = uString::Const("getResponseContentByteArray");
    ::STRINGS[33] = uString::Const("This operation is illegal after request has finished");
    ::STRINGS[34] = uString::Const("Unable to get header.");
    ::STRINGS[35] = uString::Const("onabort");
    ::STRINGS[36] = uString::Const("ondone");
    ::STRINGS[37] = uString::Const("onerror");
    ::STRINGS[38] = uString::Const("onprogress");
    ::STRINGS[39] = uString::Const("onstatechanged");
    ::STRINGS[40] = uString::Const("ontimeout");
    ::STRINGS[41] = uString::Const("buffer");
...
void Http__FuseJSHttpRequest::ctor_(::g::Fuse::Scripting::Context* context, ::g::Uno::Net::Http::HttpMessageHandlerRequest* req)
{
    ...
    uPtr(Obj())->Item(::STRINGS[19/*"enableCache"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__EnableCache_fn, this));
    uPtr(Obj())->Item(::STRINGS[20/*"setTimeout"*/], ::g::Fuse::Scripting::JSCallback::FromAction1(::TYPES[13/*Fuse.Scripting.JSCallback.FromAction<int>*/], uDelegate::New(::TYPES[14/*Uno.Action<int>*/], (void*)Http__FuseJSHttpRequest__SetTimeout_fn, this)));
    uPtr(Obj())->Item(::STRINGS[21/*"setResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[22/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseType_fn, this));
    uPtr(Obj())->Item(::STRINGS[23/*"sendAsync"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__SendAsync_fn, this));
    uPtr(Obj())->Item(::STRINGS[24/*"abort"*/], ::g::Fuse::Scripting::JSCallback::FromAction(uDelegate::New(::TYPES[15/*Uno.Action*/], (void*)Http__FuseJSHttpRequest__Abort_fn, this)));
    uPtr(Obj())->Item(::STRINGS[25/*"setHeader"*/], ::g::Fuse::Scripting::JSCallback::FromAction2(::TYPES[16/*Fuse.Scripting.JSCallback.FromAction<string, string>*/], uDelegate::New(::TYPES[17/*Uno.Action<string, string>*/], (void*)Http__FuseJSHttpRequest__SetHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[26/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc1(::TYPES[18/*Fuse.Scripting.JSCallback.FromFunc<string, string>*/], uDelegate::New(::TYPES[19/*Uno.Func<string, string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeader_fn, this)));
    uPtr(Obj())->Item(::STRINGS[27/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[20/*Fuse.Scripting.JSCallback.FromFunc<string>*/], uDelegate::New(::TYPES[21/*Uno.Func<string>*/], (void*)Http__FuseJSHttpRequest__GetResponseHeaders_fn, this)));
    uPtr(Obj())->Item(::STRINGS[28/*"getState"*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetState_fn, this));
    uPtr(Obj())->Item(::STRINGS[29/*"getResponse...*/], ::g::Fuse::Scripting::JSCallback::FromFunc(::TYPES[22/*Fuse.Scripting.JSCallback.FromFunc<int>*/], uDelegate::New(::TYPES[23/*Uno.Func<int>*/], (void*)Http__FuseJSHttpRequest__GetResponseStatus_fn, this)));
    uPtr(Obj())->Item(::STRINGS[30/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseReasonPhrase_fn, this));
    uPtr(Obj())->Item(::STRINGS[31/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentString_fn, this));
    uPtr(Obj())->Item(::STRINGS[32/*"getResponse...*/], uDelegate::New(::TYPES[8/*Fuse.Scripting.Callback*/], (void*)Http__FuseJSHttpRequest__GetResponseContentByteArray_fn, this));
}
...
{
    if (_req == NULL)
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[33/*"This operat...*/]));
}
...
uString* Http__FuseJSHttpRequest::GetResponseHeader(uString* key)
{
    ...
    if (::g::Uno::String::op_Equality(_cachedResponseHeaders, NULL))
        U_THROW(::g::Uno::InvalidOperationException::New5(::STRINGS[34/*"Unable to g...*/]));
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[35/*"onabort"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[36/*"ondone"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[37/*"onerror"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[38/*"onprogress"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[39/*"onstatechan...*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
{
    ::g::Fuse::Scripting::Function* func = uAs< ::g::Fuse::Scripting::Function*>(uPtr(Obj())->Item(::STRINGS[40/*"ontimeout"*/]), ::TYPES[2/*Fuse.Scripting.Function*/]);
...
uObject* Http__FuseJSHttpRequest::SendAsync(uArray* args)
{
    if ((args != NULL) && (uPtr(args)->Length() > 0))
    {
        ...
        else
        {
            ...
            if ((obj != NULL) && (uPtr(obj)->Item(::STRINGS[41/*"buffer"*/]) != NULL))
            {
                uArray* b1 = uAs<uArray*>(uPtr(obj)->Item(::STRINGS[41/*"buffer"*/]), ::TYPES[25/*byte[]*/]);
...
static void HttpHeaders_build(uType* type)
{
    ...
    ::TYPES[30] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(6/*ToArray<string>*/, ::g::Uno::String_typeof(), NULL);
...
uString* HttpHeaders::GetValue(uString* key)
{
    ...
    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_headers), ::g::Uno::String::ToLower(uPtr(key)), (void**)(&list), &ret6), ret6))
        return ::g::Uno::String::Join(::STRINGS[42/*", "*/], (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[30/*Uno.Collections.EnumerableExtensions.ToArray<string>*/], list));
...
uObject* TimerModule::Delete(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::g::Fuse::MarshalException_typeof()))
        {
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Timer.delete(): The parameter is not a valid timer handle"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Scripting.JavaScript/1.4.2/FuseJS/Timer.uno"), 133, uString::Const("Delete"));
        }
        else         throw __t;
    }
