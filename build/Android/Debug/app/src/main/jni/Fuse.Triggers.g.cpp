...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Busy.uno
// ----------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Busy.ScriptClass.uno");
    ...
    ::STRINGS[7] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Busy.uno");
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/BusyTask.uno
// --------------------------------------------------------------
...
static void BusyTask__cctor__fn(uType* __type)
{
    ...
    BusyTask::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[9/*Fuse.Node*/], ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[8/*Uno.Action*/], NULL), NULL)));
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("done"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, uObject_typeof()->Array(), NULL), (void*)BusyTask__done_fn), 2)));
}
...
bool BusyTask::IsBusyHandled(::g::Fuse::Node* n, int activity)
{
    ...
    for (::g::Fuse::Node* x = (::g::Fuse::Node*)uPtr(v)->FirstChild(::TYPES[4/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Node>*/, ::TYPES[9/*Fuse.Node*/], NULL)); x != NULL; x = (::g::Fuse::Node*)uPtr(x)->NextSibling(::TYPES[9/*Fuse.Node*/]->MakeMethod(3/*NextSibling<Fuse.Node>*/, ::TYPES[9/*Fuse.Node*/], NULL)))
    {
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/BusyTaskModule.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Completed.uno
// ---------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[6/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Completed>*/], ::STRINGS[9/*"reset"*/], uDelegate::New(::TYPES[7/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Completed, object[]>*/], (void*)Completed__reset_fn), 2)));
}
...
static void Completed_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Completed.ScriptClass.uno");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[6] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[7] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
...
void Completed::Cleanup(bool unroot)
{
    ...
    if (_listening)
    {
        ::g::Fuse::Triggers::BusyTask::RemoveListener(Parent(), uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Completed__Update_fn, this));
        _listening = false;
    }
}
...
void Completed::Setup()
{
    if (!_listening)
    {
        ::g::Fuse::Triggers::BusyTask::AddListener(Parent(), uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Completed__Update_fn, this));
        _listening = true;
        ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Completed__Update_fn, this), -1, 2);
    }
}
...
void Completed::Update()
{
    ...
    {
        if (Activation() == 1)
            ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Completed__DoPulse_fn, this), 0, 1);
        else
            DoPulse();
    }
}
...
static void BusyTaskModule__ConstructorClosure_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/BusyTaskModule.uno");
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.2/Triggers/ScrollRegion.uno
// --------------------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Trigger.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/StateGroup.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/ProgressAnimation.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Timeline.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/IValue.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/PulseTrigger.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileFloat.uno
// ----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/KeyboardVisible.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/RemovingAnimation.uno
// -----------------------------------------------------------------------
...
{
    ::STRINGS[17] = uString::Const("Double removal of Visual");
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/RemovingAnimation.uno");
    ::STRINGS[19] = uString::Const("Fuse.IBeginRemoveVisualListener.OnBeginRemoveVisual");
    ::STRINGS[20] = uString::Const("Unexpected done");
    ::STRINGS[21] = uString::Const("OnDone");
    ::TYPES[8] = ::g::Uno::Action_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Double remo...*/], __this, ::STRINGS[18/*"/usr/local/...*/], 49, ::STRINGS[19/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Unexpected ...*/], this, ::STRINGS[18/*"/usr/local/...*/], 62, ::STRINGS[21/*"OnDone"*/]);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.2/Triggers/Scrolled.ScriptClass.uno
// ----------------------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[16/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Scrolled>*/], ::STRINGS[22/*"check"*/], uDelegate::New(::TYPES[17/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Scrolled, object[]>*/], (void*)Scrolled__check_fn), 2)));
}

static void Scrolled_build(uType* type)
{
    ::STRINGS[22] = uString::Const("check");
    ::STRINGS[23] = uString::Const("check takes no parameters");
    ::STRINGS[24] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.2/Triggers/Scrolled.ScriptClass.uno");
    ::STRINGS[25] = uString::Const("Scrolled could not find a Scrollable control.");
    ::STRINGS[26] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.2/Triggers/Scrolled.uno");
    ::STRINGS[27] = uString::Const("OnRooted");
    ::TYPES[0] = ::g::Uno::Type_typeof();
    ::TYPES[1] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[18] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
...
{
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollViewBase*)uPtr(__this->Parent())->FindByType(::TYPES[18/*Fuse.Node.FindByType<Fuse.Controls.ScrollViewBase>*/]));

    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"Scrolled co...*/], __this, ::STRINGS[26/*"/usr/local/...*/], 35, ::STRINGS[27/*"OnRooted"*/], NULL);
        return;
    }
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"check takes...*/], s, ::STRINGS[24/*"/usr/local/...*/], 27, ::STRINGS[22/*"check"*/], NULL);
        return;
    }

    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[8/*Uno.Action*/], (void*)Scrolled__Check_fn, uPtr(s)), 1, 5);
}
// }

// /usr/local/share/uno/Packages/Fuse.Controls.ScrollView/1.4.2/Triggers/Scrolled.uno
// ----------------------------------------------------------------------------------
...
static void ScrollRegion_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[20/*Fuse.Triggers.IScrolledLength*/], offsetof(ScrollRegion, RelativeTo), 0);
}
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/State.ScriptClass.uno
// -----------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[21/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[28/*"goto"*/], uDelegate::New(::TYPES[22/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}

static void State_build(uType* type)
{
    ::STRINGS[28] = uString::Const("goto");
    ::STRINGS[29] = uString::Const("Cannot call `Goto` on an unrooted `State`");
    ::STRINGS[30] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/State.uno");
...
void State::Goto()
{
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[29/*"Cannot call...*/], NULL, ::STRINGS[30/*"/usr/local/...*/], 62, ::STRINGS[31/*"Goto"*/]);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/StateGroup.ScriptClass.uno
// ----------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[1/*Fuse.Scripting.ScriptMember[]*/], 2, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), ::STRINGS[28/*"goto"*/], uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, uObject_typeof()->Array(), NULL), (void*)StateGroup__goto__fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("gotoNext"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, uObject_typeof()->Array(), NULL), (void*)StateGroup__gotoNext_fn), 2)));
}
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("StateGroup.goto requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/StateGroup.ScriptClass.uno"), 48, uString::Const("goto_"), NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unable to find State with Name: "), name), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/StateGroup.ScriptClass.uno"), 28, uString::Const("gotoName"), NULL);
        return;
    }
...
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ProgressChanged1, value), ::TYPES[40/*Uno.UX.ValueChangedHandler`1*/]->MakeType(::g::Uno::Double_typeof(), NULL));
}
...
{
    ProgressChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ProgressChanged1, value), ::TYPES[40/*Uno.UX.ValueChangedHandler`1*/]->MakeType(::g::Uno::Double_typeof(), NULL));
}
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.seek requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Timeline.ScriptClass.uno"), 67, uString::Const("playTo"), NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.seek requires 1 argument"), n, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Timeline.ScriptClass.uno"), 116, uString::Const("seek"), NULL);
        return;
    }
...
// /usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.2/Transition.uno
// ---------------------------------------------------------------------------
...
{
    ::TYPES[23] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[24] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[8] = ::g::Uno::Action_typeof();
    ::TYPES[25] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[26] = ::g::Fuse::Internal::MiniList_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(36,
        ::TYPES[26/*Fuse.Internal.MiniList<string>*/], offsetof(Transition, _to), 0,
        ::TYPES[26/*Fuse.Internal.MiniList<string>*/], offsetof(Transition, _from), 0,
...
void Transition__OnRooted_fn(Transition* __this)
{
    ...
    if (__this->_group != NULL)
    {
        ...
        uPtr(uPtr(__this->_group)->Navigator())->add_PageProgressChanged(uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
    }
}
...
void Transition__OnUnrooted_fn(Transition* __this)
{
    ...
    if (__this->_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(__this->Animators()), ::TYPES[23/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), __this->_useAnimator, &ret2);

    if (__this->_group != NULL)
    {
        uPtr(uPtr(__this->_group)->Navigator())->remove_PageProgressChanged(uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
        uPtr(uPtr(__this->_group)->Navigator())->SetTransitionState(__this, false);
...
void Transition::AddUseTransition()
{
    ...
    if (_useAnimator != NULL)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[23/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), _useAnimator);
}
...
void Transition::OnPageProgressChanged(uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    ...
    ::g::Fuse::Navigation::NavigationPageState ps = ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(uAs<uObject*>(uPtr(_group)->Navigator(), ::TYPES[24/*Fuse.Navigation.INavigation*/])), ::TYPES[24/*Fuse.Navigation.INavigation*/]), uPtr(_group)->Page());
...
int Transition::Priority(bool isActive, bool isBackward, uString* newPath, uString* oldPath, int mode, uString* operationStyle)
{
    ...
    if (_to.Count(::TYPES[26/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (!normActive && _to.Contains(::TYPES[26/*Fuse.Internal.MiniList<string>*/], toPath))
            return priority + 20;

        return -1;
    }

    if (_from.Count(::TYPES[26/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (normActive && _from.Contains(::TYPES[26/*Fuse.Internal.MiniList<string>*/], fromPath))
            return priority + 10;
...
{
    TransitionGroup::_groupMap_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[27/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/]));
}

static void TransitionGroup_build(uType* type)
{
    ::STRINGS[32] = uString::Const("Transition must have a Navigator ancestor");
    ::STRINGS[33] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Navigation/1.4.2/Transition.uno");
    ::STRINGS[34] = uString::Const("Root");
    ::STRINGS[35] = uString::Const("Transition must have a Visual parent");
    ::TYPES[27] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), type, NULL);
    ::TYPES[28] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Transition_typeof(), NULL);
    ::TYPES[29] = ::g::Fuse::Controls::NavigationSwitchedHandler_typeof();
    ::TYPES[30] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[31] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[4] = ::g::Fuse::Visual_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(0,
        ::TYPES[31/*Fuse.Controls.Navigator*/], offsetof(TransitionGroup, _navigator), 0,
        ::TYPES[4/*Fuse.Visual*/], offsetof(TransitionGroup, _parent), 0,
        ::TYPES[28/*Uno.Collections.List<Fuse.Triggers.Transition>*/], offsetof(TransitionGroup, _states), 0,
        ::g::Fuse::Triggers::Transition_typeof(), offsetof(TransitionGroup, _selected), 0,
        ::TYPES[27/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/], (uintptr_t)&TransitionGroup::_groupMap_, uFieldFlagsStatic);
}
...
{
    _states = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[28/*Uno.Collections.List<Fuse.Triggers.Transition>*/]));
    _parent = parent;
    _navigator = navigator;
    uPtr(_navigator)->add_Switched(uDelegate::New(::TYPES[29/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
{
    uPtr(_navigator)->remove_Switched(uDelegate::New(::TYPES[29/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
void TransitionGroup::OnSwitched(uObject* sender, ::g::Fuse::Controls::NavigatorSwitchedArgs* args)
{
    ...
    if ((selectTrans == NULL) && (uPtr(_navigator)->Transition() != 1))
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_parent)->Children()), ::TYPES[30/*Uno.Collections.ICollection<Fuse.Node>*/]), trans);
        selectTrans = trans;
    }
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    {
        nav = uAs< ::g::Fuse::Controls::Navigator*>(q, ::TYPES[31/*Fuse.Controls.Navigator*/]);
        q = uPtr(q)->ContextParent();
    }

    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[32/*"Transition ...*/], t, ::STRINGS[33/*"/usr/local/...*/], 26, ::STRINGS[34/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[35/*"Transition ...*/], t, ::STRINGS[33/*"/usr/local/...*/], 33, ::STRINGS[34/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Trigger.OnPlaybackdone called with _animState == null"), __this, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Trigger.uno"), 303, uString::Const("Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone"));
        return;
    }
...
void Trigger::Bypass(int value)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(uString::Const("ExceptLayout mode indicates a problem in trigger expecations and should no tbe used"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Trigger.uno"), 110, uString::Const("set_Bypass"));
...
void Trigger::EnsureAnimationLength()
{
    ...
    n->Delay(actFore);
    n->DelayBack(actBack);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[23/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);

    if (HasBackwardAnimation())
    {
        n = ::g::Fuse::Animations::Nothing::New2();
        n->Delay(actBack);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(BackwardAnimation())->Animators()), ::TYPES[23/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), n);
    }
}
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileBool.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhilePlaying.uno
// ------------------------------------------------------------------
...
static void WhileCompleted_build(uType* type)
{
    ...
    ::TYPES[33] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhileCompleted>*/, type, NULL);
    ::TYPES[34] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhileCompleted>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
bool WhileCompleted::IsCompleted(::g::Fuse::Visual* n)
{
    ...
    if (!uIs(v, ::TYPES[32/*bool*/]))
        return false;

    return uUnbox<bool>(::TYPES[32/*bool*/], v);
}
...
void WhileCompleted::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileCompleted::_whileCompletedProp_, uBox(::TYPES[32/*bool*/], paused));

        for (WhileCompleted* wl = (WhileCompleted*)n->FirstChild(::TYPES[33/*Fuse.Visual.FirstChild<Fuse.Triggers.WhileCompleted>*/]); wl != NULL; wl = (WhileCompleted*)uPtr(wl)->NextSibling(::TYPES[34/*Fuse.Node.NextSibling<Fuse.Triggers.WhileCompleted>*/]))
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Disabled.uno
// --------------------------------------------------------------
...
static void WhileDisabled_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::WhileEnabledDisabledTrigger_type, interface4),
...
static void WhileEnabledDisabledTrigger_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileEnabledDisabledTrigger_type, interface4),
...
{
    ::TYPES[32] = ::g::Uno::Bool_typeof();
    ::TYPES[35] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePaused>*/, type, NULL);
    ::TYPES[36] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePaused>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void WhilePaused::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePaused::_whilePausedProp_, uBox(::TYPES[32/*bool*/], paused));

        for (WhilePaused* wl = (WhilePaused*)n->FirstChild(::TYPES[35/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePaused>*/]); wl != NULL; wl = (WhilePaused*)uPtr(wl)->NextSibling(::TYPES[36/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePaused>*/]))
            uPtr(wl)->SetActive(paused);
    }
}
// }
...
{
    ::TYPES[32] = ::g::Uno::Bool_typeof();
    ::TYPES[37] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePlaying>*/, type, NULL);
    ::TYPES[38] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePlaying>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
...
void WhilePlaying::SetState(::g::Fuse::Visual* n, bool playing)
{
    ...
    if (v != playing)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePlaying::_whilePlayingProp_, uBox(::TYPES[32/*bool*/], playing));

        for (WhilePlaying* wl = (WhilePlaying*)n->FirstChild(::TYPES[37/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePlaying>*/]); wl != NULL; wl = (WhilePlaying*)uPtr(wl)->NextSibling(::TYPES[38/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePlaying>*/]))
            uPtr(wl)->SetActive(playing);
    }
}
// }

// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileString.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileTrigger.uno
// ------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileValue.uno
// ----------------------------------------------------------------
...
static void WhileValue_build(uType* type)
{
    ...
    ::STRINGS[37] = uString::Const("/usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/WhileValue.uno");
    ::STRINGS[38] = uString::Const("Pulse");
    ::TYPES[39] = ::g::Fuse::Triggers::IValue_typeof();
    ::TYPES[40] = ::g::Uno::UX::ValueChangedHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetPrecalc(
    ...
    type->SetFields(37,
        ...
        ::TYPES[39/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, _source), 0,
        ::TYPES[39/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, _obj), 0,
        ::TYPES[40/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, ValueChanged1), 0);
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[36/*"`Pulse` on ...*/], this, ::STRINGS[37/*"/usr/local/...*/], 47, ::STRINGS[38/*"Pulse"*/]);
