...
#include <Fuse.PreviewStateData.Entry.h>
...
// /usr/local/share/uno/Packages/Fuse.Android/1.4.2/AndroidProperties.uno
// ----------------------------------------------------------------------
...
// public static string get_ReleaseVersion() [static] :19
...
// /usr/local/share/uno/Packages/Fuse.Android/1.4.2/AndroidApp.uno
// ---------------------------------------------------------------
...
// public Fuse.Visual get_ChildrenVisual() :66
void App__get_ChildrenVisual_fn(App* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->ChildrenVisual();
}
...
// private void PropagateBackground() :93
void App__PropagateBackground_fn(App* __this)
{
    __this->PropagateBackground();
}

// private Fuse.Visual get_RootVisual() :29
...
void App::ctor_3()
{
    _graphicsView = ::g::Fuse::Android::RootGraphicsView::New4();
    ctor_2();
    ::g::Fuse::Platform::SystemUI::OnCreate();
    ::g::Fuse::Android::StatusBarConfig::SetStatusBarColor(::g::Uno::Float4__New1(0.0f));
    ::g::Fuse::Controls::TextControl::TextRendererFactory(uDelegate::New(::g::Uno::Func1_typeof()->MakeType(::g::Fuse::Controls::TextControl_typeof(), ::g::Fuse::Controls::ITextRenderer_typeof(), NULL), (void*)::g::Fuse::Android::TextRenderer__Create_fn));
    _renderPanel = ::g::Fuse::Controls::TreeRendererPanel::New4((uObject*)App__RootViewHost::New1());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_renderPanel)->Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), _graphicsView);
    ::g::Fuse::MobileBootstrapping::Init();
    RootViewport(::g::Fuse::Controls::Native::NativeRootViewport::New4(::g::Fuse::Android::AppRoot::ViewHandle()));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(RootViewport())->Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), _renderPanel);
...
// public Fuse.Visual get_ChildrenVisual() [instance] :66
::g::Fuse::Visual* App::ChildrenVisual()
{
    return RootVisual();
}
...
void App::OnTick(uObject* sender, ::g::Uno::Platform::TimerEventArgs* args)
{
    ...
    ::g::Fuse::Time::Set(uPtr(args)->CurrentTime());
...
// private void PropagateBackground() [instance] :93
void App::PropagateBackground()
{
    uPtr(_graphicsView)->Color(Background());
}

// private Fuse.Visual get_RootVisual() [instance] :29
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/AppBase.uno
// ----------------------------------------------------------
...
static void AppBase_build(uType* type)
{
    ...
    type->SetFields(1,
        ...
        ::TYPES[0/*Uno.Collections.List<Fuse.Visual>*/], offsetof(AppBase, _selection), 0,
        ...
        ::TYPES[8/*Fuse.UnhandledExceptionHandler*/], offsetof(AppBase, UnhandledException1), 0,
...
void AppBase::DrawSelection(::g::Fuse::DrawContext* dc)
{
    ...
    if (uPtr(_selection)->Count() > 0)
    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[5/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
                {
            ...
            {
                enum1.Dispose(::TYPES[5/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]);
            }
        }
...
// protected void OnUpdate() [instance] :286
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Behavior.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Binding.uno
// ----------------------------------------------------------
...
static void Binding_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Binding.uno");
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Box.uno
// -------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/CacheFramebuffer.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Interacting.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Collision.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/Computer.uno
// -------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/NodeGroup.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Node.DataContext.uno
// -------------------------------------------------------------------
...
bool Node__DataFinder::NextData(uObject* data)
{
    ...
    else
    {
        ...
        if (obj != NULL)
        {
            ...
            {
                Resolve(obj, ::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[9/*Fuse.IObject*/]), _key));
                return false;
            }
        }
    }
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Node.ScriptClass.uno
// -------------------------------------------------------------------
...
Node__DataWatcher_type* Node__DataWatcher_typeof()
{
    ...
    type->fp_Resolve = (void(*)(::g::Fuse::Node__DataFinder*, uObject*, uObject*))Node__DataWatcher__Resolve_fn;
...
// protected override sealed void Resolve(Fuse.IObject provider, object data) :72
...
// /usr/local/share/uno/Packages/Fuse.Triggers/1.4.2/Deferred.uno
// --------------------------------------------------------------
...
static void DeferredManager_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[12/*Uno.Collections.PriorityQueue<Fuse.IDeferred>*/], (uintptr_t)&DeferredManager::_pending_, uFieldFlagsStatic,
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Diagnostics.uno
// ---------------------------------------------------------------
...
static void Diagnostic_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::Bool_typeof(), offsetof(Diagnostic, IsTemporalWarning), 0);
}
...
void Diagnostic__ToString_fn(Diagnostic* __this, uString** __retval)
{
    ...
    if (::g::Uno::String::op_Inequality(__this->FilePath, NULL))
        msg = ::g::Uno::String::op_Addition2(msg, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[14/*"<"*/], __this->FilePath), ::STRINGS[15/*":"*/]), uBox<int>(::TYPES[45/*int*/], __this->LineNumber)), ::STRINGS[16/*">"*/]));
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :267
...
// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) :249
...
// public static Uno.IDisposable ReportTemporalUserWarning(string message, object origin) :190
...
// public static Uno.IDisposable ReportTemporalWarning(Fuse.Diagnostic d) :180
...
// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) :260
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :274
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName], [Uno.Exception e]) :199
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) :237
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :210
...
// private static string UserTypeOf(object a) :222
void Diagnostics__UserTypeOf_fn(uObject* a, uString** __retval)
{
    *__retval = Diagnostics::UserTypeOf(a);
}

// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) :295
...
// public static void Deprecated(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :267
...
// public static void InternalError(string msg, [object obj], [string filePath], [int lineNumber], [string memberName]) [static] :249
...
// public static Uno.IDisposable ReportTemporalUserWarning(string message, object origin) [static] :190
...
// public static Uno.IDisposable ReportTemporalWarning(Fuse.Diagnostic d) [static] :180
uObject* Diagnostics::ReportTemporalWarning(::g::Fuse::Diagnostic* d)
{
    uPtr(d)->IsTemporalWarning = true;
...
// public static void UnknownException(string msg, Uno.Exception ex, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :260
...
// public static void Unsupported(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :274
...
// public static void UserError(string msg, object obj, [string filePath], [int lineNumber], [string memberName], [Uno.Exception e]) [static] :199
...
// public static void UserRootError(string expectedType, object actualParent, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :237
...
// public static void UserSuccess(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :210
...
// private static string UserTypeOf(object a) [static] :222
...
// public static void UserWarning(string msg, object obj, [string filePath], [int lineNumber], [string memberName]) [static] :295
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/DrawContext.uno
// --------------------------------------------------------------
...
{
    ::STRINGS[18] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/DrawContext.uno");
    ::STRINGS[19] = uString::Const("CaptureRootbuffer");
    ::STRINGS[8] = uString::Const("");
    ::STRINGS[20] = uString::Const("Clear");
    ::STRINGS[21] = uString::Const("PopRenderTarget");
    ::STRINGS[22] = uString::Const("PushRenderTarget");
    ::STRINGS[23] = uString::Const("Unpopped Scissor");
    ::STRINGS[24] = uString::Const("ReleaseRootbuffer");
    ::STRINGS[25] = uString::Const("Unpopped CullFace");
    ::STRINGS[26] = uString::Const("Unpopped Viewport");
    ::STRINGS[27] = uString::Const("Unpopped RenderTarget");
    ::STRINGS[28] = uString::Const("set_GLFramebuffer");
    ...
    type->SetDependencies(
        ...
        ::g::Fuse::Platform::SystemUI_typeof());
    type->SetFields(0,
        ::TYPES[18/*Fuse.IRenderViewport*/], offsetof(DrawContext, _viewport), 0,
        ::TYPES[14/*Uno.Collections.List<Fuse.IRenderViewport>*/], offsetof(DrawContext, _viewports), 0,
        ...
        ::TYPES[15/*Uno.Collections.List<Fuse.RenderTargetEntry>*/], offsetof(DrawContext, _renderTargets), 0,
        ...
        ::TYPES[16/*Uno.Collections.List<int4>*/], offsetof(DrawContext, _glScissors), 0,
        ::g::Uno::Int4_typeof(), offsetof(DrawContext, _glViewport), 0,
        ::TYPES[17/*Uno.Collections.List<Uno.Graphics.PolygonFace>*/], offsetof(DrawContext, _cullFaces), 0,
        ::g::Uno::Graphics::PolygonFace_typeof(), offsetof(DrawContext, _cullFace), 0,
        ::g::Uno::Bool_typeof(), offsetof(DrawContext, _IsCaching), 0,
        ::TYPES[23/*Uno.EventHandler*/], offsetof(DrawContext, RenderTargetChange1), 0);
}
...
void DrawContext::CaptureRootbuffer()
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 86, ::STRINGS[19/*"CaptureRoot...*/]);
...
void DrawContext::Clear(::g::Uno::Float4 color, float depth)
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 240, ::STRINGS[20/*"Clear"*/]);
}
...
void DrawContext::GLFramebuffer(uint32_t value)
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 152, ::STRINGS[28/*"set_GLFrame...*/]);
}
...
void DrawContext::GLScissor(::g::Uno::Int4 value)
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 281, ::STRINGS[29/*"set_GLScissor"*/]);
}
...
void DrawContext::GLViewportPixelSize(::g::Uno::Int2 value)
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 325, ::STRINGS[30/*"set_GLViewp...*/]);
}
...
void DrawContext::PopRenderTarget()
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 202, ::STRINGS[21/*"PopRenderTa...*/]);
...
void DrawContext::PushRenderTarget2(::g::Uno::Graphics::RenderTarget* rt, ::g::Uno::Int2 viewportPixelSize, ::g::Uno::Int4 glscissor)
{
    ...
    CheckGLError(::STRINGS[18/*"/usr/local/...*/], 181, ::STRINGS[22/*"PushRenderT...*/]);
    _renderTarget = rt;
...
void DrawContext::ReleaseRootbuffer()
{
    if (uPtr(_glScissors)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[23/*"Unpopped Sc...*/], this, ::STRINGS[18/*"/usr/local/...*/], 112, ::STRINGS[24/*"ReleaseRoot...*/]);

    uPtr(_glScissors)->Clear();

    if (uPtr(_cullFaces)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[25/*"Unpopped Cu...*/], this, ::STRINGS[18/*"/usr/local/...*/], 116, ::STRINGS[24/*"ReleaseRoot...*/]);

    uPtr(_cullFaces)->Clear();

    if (uPtr(_viewports)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[26/*"Unpopped Vi...*/], this, ::STRINGS[18/*"/usr/local/...*/], 120, ::STRINGS[24/*"ReleaseRoot...*/]);

    uPtr(_viewports)->Clear();

    if (uPtr(_renderTargets)->Count() > 0)
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Unpopped Re...*/], this, ::STRINGS[18/*"/usr/local/...*/], 124, ::STRINGS[24/*"ReleaseRoot...*/]);
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.DrawSelection.uno
// -----------------------------------------------------------------------
...
static void DrawHelpers_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[24/*float2[]*/], offsetof(DrawHelpers, DrawLocalRect_Vertices_1e24cb92_1_1_4), 0,
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/PreviewState.uno
// ---------------------------------------------------------------

// private sealed class PreviewStateData.Entry :69
// {
static void PreviewStateData__Entry_build(uType* type)
{
    type->SetFields(0,
        uObject_typeof(), offsetof(PreviewStateData__Entry, Data), 0,
        ::g::Uno::Bool_typeof(), offsetof(PreviewStateData__Entry, Consumed), 0);
}
...
uType* PreviewStateData__Entry_typeof()
{
    ...
    uTypeOptions options;
    options.FieldCount = 2;
    options.ObjectSize = sizeof(PreviewStateData__Entry);
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.PreviewStateData.Entry", options);
    type->fp_build_ = PreviewStateData__Entry_build;
    return type;
}
// }

// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Children.Enumerable.uno
// -----------------------------------------------------------------------------
...
static void Visual__Enumerator_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[6/*Fuse.Visual*/], offsetof(Visual__Enumerator, _parent), 0,
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/FastMatrix.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.FastProperties1.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.FastProperties2.uno
// -------------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/FileSourceConverter.uno
// ------------------------------------------------------------------------
...
static void FileSourceConverter_build(uType* type)
{
    ...
    ::TYPES[31] = ::g::Uno::IDisposable_typeof();
    ::TYPES[9] = ::g::Fuse::IObject_typeof();
    type->SetDependencies(
        ::g::Uno::Type_typeof());
    type->SetInterfaces(
...
uObject* FileSourceConverter::TryConvert(uType* t, uObject* obj)
{
    ...
    if (uIs(obj, ::TYPES[27/*string*/]))
    {
        ...
        uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(::g::Uno::IO::Bundle::AllFiles()), ::TYPES[28/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/]));

        try
        {
            {
                while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
                {
                    ...
                    {
                        uObject* __uno_retval = ::g::Uno::UX::BundleFileSource::New1(f);
                        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum1), ::TYPES[31/*Uno.IDisposable*/]));
                        return __uno_retval;
                    }
                }
            }
        ...
        return ::g::Fuse::JSFileSource::New1(uAs<uString*>(::g::Fuse::IObject::Item(uInterface(uPtr((uObject*)obj), ::TYPES[9/*Fuse.IObject*/]), ::STRINGS[31/*"path"*/]), ::TYPES[27/*string*/]));
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/IViewport.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/LayoutParams.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Font.uno
// --------------------------------------------------------
...
{
    Font::Thin_ = ::g::Fuse::SystemFont::New3(::STRINGS[32/*"sans-serif-...*/], 0, 1);
    Font::Light_ = ::g::Fuse::SystemFont::New3(::STRINGS[33/*"sans-serif-...*/], 0, 2);
    Font::Regular_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 0, 3);
    Font::Medium_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 0, 4);
    Font::Bold_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 0, 6);
    Font::ThinItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[32/*"sans-serif-...*/], 1, 1);
    Font::LightItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[33/*"sans-serif-...*/], 1, 2);
    Font::Italic_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 1, 3);
    Font::MediumItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 1, 4);
    Font::BoldItalic_ = ::g::Fuse::SystemFont::New3(::STRINGS[34/*"sans-serif"*/], 1, 6);
}

static void Font_build(uType* type)
{
    ::STRINGS[32] = uString::Const("sans-serif-thin");
    ::STRINGS[33] = uString::Const("sans-serif-light");
    ::STRINGS[34] = uString::Const("sans-serif");
    type->SetFields(0,
...
// internal Uno.UX.FileSource get_FileSource() :33
...
// internal Uno.UX.FileSource get_FileSource() [instance] :33
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/FramebufferPool.uno
// -------------------------------------------------------------------
...
static void FramebufferPoolImpl_build(uType* type)
{
    ...
    ::TYPES[32] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), NULL);
    ::TYPES[33] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), ::g::Uno::Int_typeof(), NULL);
    ::TYPES[34] = ::g::Uno::Collections::HashSet_typeof()->MakeType(::g::Uno::Graphics::Framebuffer_typeof(), NULL);
    ::TYPES[35] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[36] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::CacheFramebuffer_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Resources::DisposalManager_typeof(),
    ...
    type->SetFields(0,
        ...
        ::TYPES[32/*Uno.Collections.List<framebuffer>*/], offsetof(FramebufferPoolImpl, framebufferPool), 0,
        ::TYPES[33/*Uno.Collections.Dictionary<framebuffer, int>*/], offsetof(FramebufferPoolImpl, lastFrameUsed), 0,
        ::TYPES[34/*Uno.Collections.HashSet<framebuffer>*/], offsetof(FramebufferPoolImpl, lockedFramebuffers), 0,
        ::TYPES[35/*Uno.Collections.List<Fuse.CacheFramebuffer>*/], offsetof(FramebufferPoolImpl, cacheFramebuffers), 0,
...
{
    framebufferPool = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[32/*Uno.Collections.List<framebuffer>*/]));
    lastFrameUsed = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[33/*Uno.Collections.Dictionary<framebuffer, int>*/]));
    lockedFramebuffers = ((::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[34/*Uno.Collections.HashSet<framebuffer>*/]));
    cacheFramebuffers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[35/*Uno.Collections.List<Fuse.CacheFramebuffer>*/]));
...
void FramebufferPoolImpl::CollectCacheFramebuffers()
{
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[36/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]))
            {
                ::g::Fuse::CacheFramebuffer* cfb = enum1.Current(::TYPES[36/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]);
                sum = sum + uPtr(cfb)->FramesSinceLastUse();
            }
        }
        {
            enum1.Dispose(::TYPES[36/*Uno.Collections.List<Fuse.CacheFramebuffer>.Enumerator*/]);
        }
    }
...
::g::Uno::Graphics::Framebuffer* FramebufferPoolImpl::FindBuffer(int width, int height, int format, int flags)
{
    ...
    if ((width > maxSize) || (height > maxSize))
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[35/*"Attempted t...*/], uBox<int>(::TYPES[45/*int*/], width)), ::STRINGS[36/*"x"*/]), uBox<int>(::TYPES[45/*int*/], height)), ::STRINGS[37/*" framebuffe...*/]), uBox<int>(::TYPES[45/*int*/], maxSize)), ::STRINGS[36/*"x"*/]), uBox<int>(::TYPES[45/*int*/], maxSize))));
...
{
    ::TYPES[37] = ::g::Fuse::IFrustum_typeof();
    type->SetFields(0,
...
{
    if (::g::Fuse::IFrustum::TryGetProjectionTransform(uInterface(uPtr(frustum), ::TYPES[37/*Fuse.IFrustum*/]), viewport, &ProjectionTransform) && ::g::Fuse::IFrustum::TryGetProjectionTransformInverse(uInterface(uPtr(frustum), ::TYPES[37/*Fuse.IFrustum*/]), viewport, &ProjectionTransformInverse))
    {
        ViewTransform = ::g::Fuse::IFrustum::GetViewTransform(uInterface(uPtr(frustum), ::TYPES[37/*Fuse.IFrustum*/]), viewport);
        ViewTransformInverse = ::g::Fuse::IFrustum::GetViewTransformInverse(uInterface(frustum, ::TYPES[37/*Fuse.IFrustum*/]), viewport);
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/GraphicsWorker.uno
// ------------------------------------------------------------------
...
{
    GraphicsWorker::_exceptionQueue_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[38/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/]));
}
...
static void GraphicsWorker_build(uType* type)
{
    ...
    ::STRINGS[42] = uString::Const("/usr/local/share/uno/Packages/Fuse.Common/1.4.2/GraphicsWorker.uno");
    ...
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[1] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[40] = ::g::Uno::Threading::ConcurrentQueue_typeof()->MakeType(::TYPES[2/*Uno.Action*/], NULL);
    ::TYPES[41] = ::g::Uno::Threading::ThreadStart_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(0,
        ::TYPES[40/*Uno.Threading.ConcurrentQueue<Uno.Action>*/], (uintptr_t)&GraphicsWorker::_work_, uFieldFlagsStatic,
        ...
        ::TYPES[38/*Uno.Threading.ConcurrentQueue<Uno.Exception>*/], (uintptr_t)&GraphicsWorker::_exceptionQueue_, uFieldFlagsStatic);
}
...
void GraphicsWorker::Run()
{
    ...
    while (!GraphicsWorker::_terminating_)
    {
        ...
        if ((::g::Uno::Threading::ConcurrentQueue__TryDequeue_fn(uPtr(GraphicsWorker::_work_), (void**)(&a), &ret2), ret2))
        {
            ...
            {
                ::g::Uno::Exception* e = __t.Exception;
                ::g::Fuse::Diagnostics::UnknownException(::STRINGS[41/*"GraphicsWor...*/], e, a, ::STRINGS[42/*"/usr/local/...*/], 109, ::STRINGS[43/*"Run"*/]);
...
void GraphicsWorker::Start()
{
    ...
    ::g::Fuse::Platform::Lifecycle::add_Terminating(uDelegate::New(::TYPES[1/*Uno.Action<Fuse.Platform.ApplicationState>*/], (void*)GraphicsWorker__OnTerminating_fn));
    GraphicsWorker::_work_ = ((::g::Uno::Threading::ConcurrentQueue*)::g::Uno::Threading::ConcurrentQueue::New1(::TYPES[40/*Uno.Threading.ConcurrentQueue<Uno.Action>*/]));
    GraphicsWorker::_resetEvent_ = ::g::Uno::Threading::AutoResetEvent::New2(false);
    GraphicsWorker::_thread_ = ::g::Uno::Threading::Thread::New2(uDelegate::New(::TYPES[41/*Uno.Threading.ThreadStart*/], (void*)GraphicsWorker__Run_fn));
    uPtr(GraphicsWorker::_thread_)->Start();
}
// }

// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Translation.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/HitTestContext.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.HitTest.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/IObject.uno
// -----------------------------------------------------------

// public abstract interface IArray :15
// {
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.BeginRemove.uno
// ---------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/Marshal.Convert.uno
// --------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Scaling.uno
// ----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/RootViewport.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/IFrustum.uno
// -----------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Resources/ILoading.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/NameRegistry.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Node.Rooting.uno
// ---------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Layout.uno
// ----------------------------------------------------------------
...
// public abstract interface IObject :35
// {
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Children.uno
// ------------------------------------------------------------------
...
uInterfaceType* IPreviewStateSaver_typeof()
{
    ...
    type = uInterfaceType::New("Fuse.IPreviewStateSaver", 0, 0);
    return type;
}
// }

// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Properties.uno
// --------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Templates.uno
// -------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Transform.uno
// ------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/UpdateManager.uno
// -----------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Json.Parse.uno
// --------------------------------------------------------------
...
static void Json_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("null");
    ::STRINGS[52] = uString::Const("true");
    ::STRINGS[53] = uString::Const("false");
    ::TYPES[42] = ::g::Uno::Collections::HashSet_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::String_typeof();
    ::TYPES[43] = ::g::Uno::Double_typeof();
    ::TYPES[44] = ::g::Uno::Float_typeof();
    ::TYPES[45] = ::g::Uno::Int_typeof();
    ::TYPES[46] = ::g::Uno::Bool_typeof();
    ::TYPES[9] = ::g::Fuse::IObject_typeof();
    ::TYPES[47] = ::TYPES[27/*string*/]->Array();
    ::TYPES[48] = ::g::Uno::Array_typeof()->MakeMethod(1/*Copy<string>*/, ::TYPES[27/*string*/], NULL);
    ::TYPES[49] = ::g::Uno::Array_typeof()->MakeMethod(5/*Sort<string>*/, ::TYPES[27/*string*/], NULL);
    ::TYPES[50] = ::g::Uno::Comparison_typeof()->MakeType(::TYPES[27/*string*/], NULL);
    ::TYPES[51] = ::g::Fuse::IArray_typeof();
}
...
uString* Json::Stringify(uObject* value, bool normalized)
{
    ...
    Json::Stringify1(value, normalized, sb, (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::TYPES[42/*Uno.Collections.HashSet<object>*/]));
    return sb->ToString();
}
...
void Json::Stringify1(uObject* value, bool normalized, ::g::Uno::Text::StringBuilder* sb, ::g::Uno::Collections::HashSet* visitedSet)
{
    ...
    else if (uIs(value, ::TYPES[43/*double*/]))
        uPtr(sb)->Append2(Json::ToLiteral1(uUnbox<double>(::TYPES[43/*double*/], value)));
    else if (uIs(value, ::TYPES[44/*float*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<float>(::TYPES[44/*float*/], value)));
    else if (uIs(value, ::TYPES[45/*int*/]))
        uPtr(sb)->Append2(Json::ToLiteral1((double)uUnbox<int>(::TYPES[45/*int*/], value)));
    else if (uIs(value, ::TYPES[46/*bool*/]))
        uPtr(sb)->Append2(Json::ToLiteral(uUnbox<bool>(::TYPES[46/*bool*/], value)));
    else if (uIs(value, ::TYPES[9/*Fuse.IObject*/]))
    {
        ...
        uArray* keys = uArray::New(::TYPES[47/*string[]*/], uPtr(::g::Fuse::IObject::Keys(uInterface(uPtr(obj), ::TYPES[9/*Fuse.IObject*/])))->Length());
        ::g::Uno::Array::Copy1(::TYPES[48/*Uno.Array.Copy<string>*/], ::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[9/*Fuse.IObject*/])), keys, uPtr(::g::Fuse::IObject::Keys(uInterface(obj, ::TYPES[9/*Fuse.IObject*/])))->Length());

        if (normalized)
            ::g::Uno::Array::Sort1(::TYPES[49/*Uno.Array.Sort<string>*/], keys, uDelegate::New(::TYPES[50/*Uno.Comparison<string>*/], (void*)::g::Uno::String__Compare_fn));
    ...
    else if (uIs(value, ::TYPES[51/*Fuse.IArray*/]))
    {
        ...
        uObject* arr = uAs<uObject*>(value, ::TYPES[51/*Fuse.IArray*/]);
        uPtr(sb)->Append2(::STRINGS[49/*"["*/]);

        for (int i1 = 0; i1 < ::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/])); i1++)
        {
            if (i1 > 0)
                uPtr(sb)->Append2(::STRINGS[47/*","*/]);

            Json::Stringify1(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), i1), normalized, sb, visitedSet);
        }
        ...
        uPtr(sb)->Append2(::STRINGS[51/*"null"*/]);
}
...
{
    if (b)
        return ::STRINGS[52/*"true"*/];
    else
        return ::STRINGS[53/*"false"*/];
}
...
{
    if ((double)(int)s == s)
        return ::g::Uno::Int::ToString((int)s, ::TYPES[45/*int*/]);

    return ::g::Uno::Double::ToString(s, ::TYPES[43/*double*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/KeyboardBootstrapper.uno
// -----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/Marshal.Cast.uno
// -----------------------------------------------------------------
...
{
    Marshal::_computers_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[26/*Uno.Type*/], ::g::Fuse::Computer_typeof(), NULL)));
    Marshal::_converters_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List`1*/]->MakeType(Marshal__IConverter_typeof(), NULL)));
    ::g::Fuse::NumberComputer* number = ::g::Fuse::NumberComputer::New1();
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[43/*double*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[44/*float*/], number);
    ::g::Uno::Collections::Dictionary__Add_fn(uPtr(Marshal::_computers_), ::TYPES[45/*int*/], number);
...
// private static Uno.UX.Size StringToSize(string o) :293
void Marshal__StringToSize_fn(uString* o, ::g::Uno::UX::Size* __retval)
{
    *__retval = Marshal::StringToSize(o);
}

// private static Uno.UX.Size2 StringToSize2(string o) :279
...
// public static bool TryToZeroFloat4(object o, float4& value, int& size) :146
...
// private static Uno.UX.Size StringToSize(string o) [static] :293
...
// private static Uno.UX.Size2 StringToSize2(string o) [static] :279
::g::Uno::UX::Size2 Marshal::StringToSize2(uString* o)
{
    Marshal_typeof()->Init();

    if (::g::Uno::String::Contains(uPtr(o), ::STRINGS[47/*","*/]))
    {
...
bool Marshal::ToBool(uObject* v)
{
    ...
    if (uIs(v, ::TYPES[46/*bool*/]))
        return uUnbox<bool>(::TYPES[46/*bool*/], v);
    else if (uIs(v, ::TYPES[27/*string*/]))
    {
        uString* s = uCast<uString*>(v, ::TYPES[27/*string*/]);

        if (::g::Uno::String::op_Equality(s, ::STRINGS[52/*"true"*/]))
            return true;

        if (::g::Uno::String::op_Equality(s, uString::Const("True")))
            return true;

        if (::g::Uno::String::op_Equality(s, ::STRINGS[53/*"false"*/]))
            return false;
    ...
    U_THROW(::g::Fuse::MarshalException::New4(v, ::TYPES[46/*bool*/]));
}
...
double Marshal::ToDouble(uObject* v)
{
    ...
    U_THROW(::g::Fuse::MarshalException::New4(v, ::TYPES[43/*double*/]));
}
...
bool Marshal::ToDouble1(uObject* v, double* res)
{
    ...
    if (uIs(v, ::TYPES[43/*double*/]))
    {
        *res = uUnbox<double>(::TYPES[43/*double*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[44/*float*/]))
    {
        *res = (double)uUnbox<float>(::TYPES[44/*float*/], v);
        return true;
    }
    else if (uIs(v, ::TYPES[27/*string*/]))
        return Marshal::ToDouble2(uCast<uString*>(v, ::TYPES[27/*string*/]), res);
    else if (uIs(v, ::TYPES[45/*int*/]))
    {
        *res = (double)uUnbox<int>(::TYPES[45/*int*/], v);
        return true;
    }
...
// public static float ToFloat(object o) [static] :220
float Marshal::ToFloat(uObject* o)
{
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[44/*float*/]))
        return uUnbox<float>(::TYPES[44/*float*/], o);
    else
        return (float)Marshal::ToDouble(o);
}

// public static float2 ToFloat2(object o) [static] :214
::g::Uno::Float2 Marshal::ToFloat2(uObject* o)
{
    ...
    if (uIs(o, ::g::Uno::Float2_typeof()))
        ...
        return (ind2 = Marshal::ToFloat43(o), ::g::Uno::Float2__New2(ind2.X, ind2.Y));
}

// public static float3 ToFloat3(object o) [static] :208
::g::Uno::Float3 Marshal::ToFloat3(uObject* o)
{
    ...
    if (uIs(o, ::g::Uno::Float3_typeof()))
        ...
        return (ind1 = Marshal::ToFloat43(o), ::g::Uno::Float3__New2(ind1.X, ind1.Y, ind1.Z));
}

// private static float4 ToFloat4(float f) [static] :77
::g::Uno::Float4 Marshal::ToFloat4(float f)
{
    Marshal_typeof()->Init();
    return ::g::Uno::Float4__New1(f);
}

// private static float4 ToFloat4(float2 f) [static] :72
::g::Uno::Float4 Marshal::ToFloat41(::g::Uno::Float2 f)
{
    Marshal_typeof()->Init();
    return ::g::Uno::Float4__New2(f.X, f.Y, f.X, f.Y);
}

// private static float4 ToFloat4(float3 f) [static] :67
::g::Uno::Float4 Marshal::ToFloat42(::g::Uno::Float3 f)
{
    Marshal_typeof()->Init();
    return ::g::Uno::Float4__New2(f.X, f.Y, f.Z, 1.0f);
}

// public static float4 ToFloat4(object o) [static] :82
::g::Uno::Float4 Marshal::ToFloat43(uObject* o)
{
    Marshal_typeof()->Init();
    ...
    if (uIs(o, ::g::Uno::Float4_typeof()))
        ...
        return Marshal::ToFloat42(uUnbox< ::g::Uno::Float3>(::g::Uno::Float3_typeof(), o));
    else if (uIs(o, ::g::Uno::Float2_typeof()))
        return Marshal::ToFloat41(uUnbox< ::g::Uno::Float2>(::g::Uno::Float2_typeof(), o));
    else if (uIs(o, ::TYPES[44/*float*/]))
        return Marshal::ToFloat4(uUnbox<float>(::TYPES[44/*float*/], o));
    ...
    else if (uIs(o, ::TYPES[51/*Fuse.IArray*/]))
    {
        uObject* a = (uObject*)o;
        float x1 = (::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[51/*Fuse.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(a), ::TYPES[51/*Fuse.IArray*/]), 0)) : 0.0f;
        float y1 = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 1)) : 0.0f;
        float z = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 2)) : 0.0f;
        float w = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 3)) : 1.0f;

        switch (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])))
        {
            case 0:
                return uDefault< ::g::Uno::Float4>();
            case 1:
                return Marshal::ToFloat4(x1);
            case 2:
                return Marshal::ToFloat41(::g::Uno::Float2__New2(x1, y1));
            case 3:
                return Marshal::ToFloat42(::g::Uno::Float3__New2(x1, y1, z));
            default:
...
// public static int ToInt(object o) [static] :226
int Marshal::ToInt(uObject* o)
{
    Marshal_typeof()->Init();

    if (uIs(o, ::TYPES[45/*int*/]))
        return uUnbox<int>(::TYPES[45/*int*/], o);
    else
        return (int)Marshal::ToDouble(o);
}

// public static Uno.UX.Size ToSize(object o) [static] :262
...
// public static Uno.UX.Size2 ToSize2(object o) [static] :270
...
uObject* Marshal::ToVector(uObject* arr)
{
    ...
    if (::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/])) == 1)
    {
        if (uIs((uObject*)::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0), ::g::Uno::UX::Size_typeof()))
            return uBox(::g::Uno::UX::Size_typeof(), uUnbox< ::g::Uno::UX::Size>(::g::Uno::UX::Size_typeof(), ::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)));
        else
            return uBox(::TYPES[44/*float*/], Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)));
    }
    else if (::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/])) == 2)
    {
        if (uIs((uObject*)::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0), ::g::Uno::UX::Size_typeof()) || uIs((uObject*)::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 1), ::g::Uno::UX::Size_typeof()))
            return uBox(::g::Uno::UX::Size2_typeof(), ::g::Uno::UX::Size2__New1(Marshal::ToSize(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)), Marshal::ToSize(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 1))));
        else
            return uBox(::g::Uno::Float2_typeof(), ::g::Uno::Float2__New2(Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 1))));
    }
    else if (::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/])) == 3)
        return uBox(::g::Uno::Float3_typeof(), ::g::Uno::Float3__New2(Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 1)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 2))));
    else if (::g::Fuse::IArray::Length(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/])) == 4)
        return uBox(::g::Uno::Float4_typeof(), ::g::Uno::Float4__New2(Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 0)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 1)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 2)), Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(arr), ::TYPES[51/*Fuse.IArray*/]), 3))));
    else
...
bool Marshal::TryConvertTo(uType* t, uObject* o, uObject** res, uObject* diagnosticSource)
{
    ...
    {
        {
            ...
            {
                if (::g::Uno::Type::op_Equality(t, ::TYPES[43/*double*/]))
                {
                    *res = uBox(::TYPES[43/*double*/], Marshal::ToDouble(o));
                    return true;
                }
                ...
                else if (::g::Uno::Type::op_Equality(t, ::TYPES[44/*float*/]))
                {
                    *res = uBox(::TYPES[44/*float*/], Marshal::ToFloat(o));
                    return true;
                }
                else if (::g::Uno::Type::op_Equality(t, ::TYPES[45/*int*/]))
                {
                    *res = uBox<int>(::TYPES[45/*int*/], Marshal::ToInt(o));
                    return true;
                }
                else if (::g::Uno::Type::op_Equality(t, ::TYPES[46/*bool*/]))
                {
                    *res = uBox(::TYPES[46/*bool*/], Marshal::ToBool(o));
                    return true;
                }
                ...
                {
                    *res = uBox(::g::Uno::Float4_typeof(), Marshal::ToFloat43(o));
                    return true;
                }
            ...
            if (::g::Uno::Type::op_Equality(t, ::TYPES[51/*Fuse.IArray*/]))
            {
                if (uIs(o, ::TYPES[51/*Fuse.IArray*/]))
                    *res = o;
                else
    ...
    if (diagnosticSource != NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[54/*"Cannot conv...*/], o), uString::Const("' to target type '")), t), ::STRINGS[56/*"'"*/]), diagnosticSource, uString::Const("/usr/local/share/uno/Packages/Fuse.Marshal/1.4.2/Marshal.Convert.uno"), 103, uString::Const("TryConvertTo"), NULL);

    *res = NULL;
    return false;
}

// public static bool TryToZeroFloat4(object o, float4& value, int& size) [static] :146
bool Marshal::TryToZeroFloat4(uObject* o, ::g::Uno::Float4* value, int* size)
{
    ...
    {
        uObject* a = (uObject*)o;
        float x = (::g::Fuse::IArray::Length(uInterface(uPtr(a), ::TYPES[51/*Fuse.IArray*/])) > 0) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(uPtr(a), ::TYPES[51/*Fuse.IArray*/]), 0)) : 0.0f;
        float y = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 1) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 1)) : 0.0f;
        float z = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 2) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 2)) : 0.0f;
        float w = (::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/])) > 3) ? Marshal::ToFloat(::g::Fuse::IArray::Item(uInterface(a, ::TYPES[51/*Fuse.IArray*/]), 3)) : 0.0f;
        *value = ::g::Uno::Float4__New2(x, y, z, w);
        *size = ::g::Fuse::IArray::Length(uInterface(a, ::TYPES[51/*Fuse.IArray*/]));
        return true;
    }
...
{
    ::STRINGS[54] = uString::Const("Cannot convert '");
    ::STRINGS[55] = uString::Const("' to required target type '");
...
{
    ctor_1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[54/*"Cannot conv...*/], v), ::STRINGS[55/*"' to requir...*/]), t), ::STRINGS[56/*"'"*/]));
}
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/MobileBootstrapping.uno
// ----------------------------------------------------------------------
...
{
    ::TYPES[1] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Platform::ApplicationState_typeof(), NULL);
    ::TYPES[52] = ::g::Uno::EventHandler1_typeof()->MakeType(::g::Uno::Platform::KeyEventArgs_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::Platform::CoreApp_typeof());
    type->SetFields(0,
...
void MobileBootstrapping::Init()
{
    ...
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyDown(uDelegate::New(::TYPES[52/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyPressed_fn));
    ::g::Uno::Platform::EventSources::HardwareKeys::add_KeyUp(uDelegate::New(::TYPES[52/*Uno.EventHandler<Uno.Platform.KeyEventArgs>*/], (void*)::g::Fuse::KeyboardBootstrapper__OnKeyReleased_fn));
}
...
{
    NameRegistry::_nameToObj_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[53/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/]));
    NameRegistry::_names_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[54/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/]));
    NameRegistry::_listeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[55/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/]));
}

static void NameRegistry_build(uType* type)
{
    ::TYPES[53] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), NULL);
    ::TYPES[54] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), ::g::Uno::UX::Selector_typeof(), NULL);
    ::TYPES[55] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL), NULL);
    ::TYPES[56] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::INameListener_typeof(), NULL);
    ::TYPES[57] = ::g::Fuse::INameListener_typeof();
    ::TYPES[58] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::UX::Selector_typeof());
    type->SetFields(0,
        ::TYPES[53/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.Node>>*/], (uintptr_t)&NameRegistry::_nameToObj_, uFieldFlagsStatic,
        ::TYPES[54/*Uno.Collections.Dictionary<Fuse.Node, Uno.UX.Selector>*/], (uintptr_t)&NameRegistry::_names_, uFieldFlagsStatic,
        ::TYPES[55/*Uno.Collections.Dictionary<Uno.UX.Selector, Uno.Collections.List<Fuse.INameListener>>*/], (uintptr_t)&NameRegistry::_listeners_, uFieldFlagsStatic);
}
...
void NameRegistry::AddListener(::g::Uno::UX::Selector name, uObject* listener)
{
    ...
    if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners_), uCRef(name), &ret5), ret5))
        ::g::Uno::Collections::Dictionary__Add_fn(uPtr(NameRegistry::_listeners_), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[56/*Uno.Collections.List<Fuse.INameListener>*/]));
...
void NameRegistry::NotifyNameChanged(::g::Fuse::Node* obj, ::g::Uno::UX::Selector name)
{
    ...
    if ((::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_listeners_), uCRef(name), &ret12), ret12))
        ...
        for (array2 = (uArray*)uPtr((::g::Uno::Collections::Dictionary__get_Item_fn(uPtr(NameRegistry::_listeners_), uCRef(name), &ret13), ret13))->ToArray(), index3 = 0, length4 = uPtr(array2)->Length(); index3 < length4; ++index3)
        {
            ...
            ::g::Fuse::INameListener::OnNameChanged(uInterface(uPtr(listener), ::TYPES[57/*Fuse.INameListener*/]), obj, name);
        }
}
    ...
    if (::g::Uno::UX::Selector__op_Inequality(name, oldName))
    {
        ...
        else
        {
            ...
            if (!(::g::Uno::Collections::Dictionary__ContainsKey_fn(uPtr(NameRegistry::_nameToObj_), uCRef(name), &ret26), ret26))
                ::g::Uno::Collections::Dictionary__set_Item_fn(uPtr(NameRegistry::_nameToObj_), uCRef(name), (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[58/*Uno.Collections.List<Fuse.Node>*/]));
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/NameValuePair.uno
// -----------------------------------------------------------------
...
static void NameValuePair_build(uType* type)
{
    ...
    ::STRINGS[59] = uString::Const("Object (NameValuePair) does not contain the given key");
...
void NameValuePair__FuseIObjectget_Item_fn(NameValuePair* __this, uString* key, uObject** __retval)
{
    if (::g::Uno::String::op_Inequality(key, __this->Name()))
        U_THROW(::g::Uno::ArgumentException::New4(::STRINGS[59/*"Object (Nam...*/]));
...
{
    return *__retval = uArray::Init<uString*>(::TYPES[47/*string[]*/], 1, (uString*)__this->Name()), void();
}
...
{
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[57/*"("*/], __this->Name()), ::STRINGS[12/*": "*/]), __this->Value()), ::STRINGS[58/*")"*/]), void();
}
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Node.Bindings.uno
// ----------------------------------------------------------------
...
static void Node__cctor__fn(uType* __type)
{
    ...
    Node::_dataListeners_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::g::Uno::Collections::Dictionary_typeof()->MakeType(::TYPES[27/*string*/], ::TYPES[94/*Uno.Collections.List`1*/]->MakeType(Node__IDataListener_typeof(), NULL), NULL)));
    Node::_laterReleaseRooting_ = uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)Node__LaterReleaseRooting_fn);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[83/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New2(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("_createWatcher"), uDelegate::New(::g::Uno::Func3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], uObject_typeof(), NULL), (void*)Node___createWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("_destroyWatcher"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], NULL), (void*)Node___destroyWatcher_fn), 1), (::g::Fuse::Scripting::ScriptMethodInline*)::g::Fuse::Scripting::ScriptMethodInline::New1(uString::Const("findData"), 1, uString::Const("function(key) { return Observable._getDataObserver(this, key); }"))));
}
...
// internal virtual Fuse.Node GetLastNodeInGroup() :135
void Node__GetLastNodeInGroup_fn(Node* __this, Node** __retval)
{
    return *__retval = __this, void();
}

// public T GetNearestAncestorOfType<T>() :170
...
void Node::AddDataListener(uString* key, uObject* listener)
{
    ...
    {
        listeners = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List`1*/]->MakeType(Node__IDataListener_typeof(), NULL));
...
{
    return uAs< ::g::Uno::Collections::List*>(_bindings, ::TYPES[94/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Binding_typeof(), NULL));
}
...
void Node::EnumerateData(uObject* e)
{
    ...
    while (n != NULL)
    {
        ...
        if (p != NULL)
            ...
            for (Node* dp = (Node*)uPtr(p)->LastChild(::TYPES[6/*Fuse.Visual*/]->MakeMethod(7/*LastChild<Fuse.Node>*/, Node_typeof(), NULL)); dp != NULL; dp = (Node*)uPtr(dp)->PreviousSibling(Node_typeof()->MakeMethod(4/*PreviousSibling<Fuse.Node>*/, Node_typeof(), NULL)))
            {
...
// internal T FindBehavior<T>() [instance] :141
Node* Node::FindBehavior(uType* __type)
{
    ...
    while (from != NULL)
    {
        ...
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(from, ::TYPES[6/*Fuse.Visual*/]);
...
// public T FindByType<T>() [instance] :164
...
// public T GetNearestAncestorOfType<T>() [instance] :170
...
{
    ::g::Uno::Collections::List* list = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Binding_typeof(), NULL));
...
::g::Fuse::Node_type* NodeGroupBase_typeof()
{
    ...
    type->fp_GetLastNodeInGroup = (void(*)(::g::Fuse::Node*, ::g::Fuse::Node**))NodeGroupBase__GetLastNodeInGroup_fn;
...
// internal override sealed Fuse.Node GetLastNodeInGroup() :236
void NodeGroupBase__GetLastNodeInGroup_fn(NodeGroupBase* __this, ::g::Fuse::Node** __retval)
{
    if ((__this->_addedNodes == NULL) || (uPtr(__this->_addedNodes)->Length() == 0))
        return *__retval = __this, void();

    return *__retval = uPtr(uPtr(__this->_addedNodes)->Strong< ::g::Fuse::Node*>(uPtr(__this->_addedNodes)->Length() - 1))->GetLastNodeInGroup(), void();
}
...
void NodeGroupBase::AddContent()
{
    ...
    if (Parent() == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("AddContent called prior to having a Parent"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/NodeGroup.uno"), 161, uString::Const("AddContent"));
        return;
    }
    ...
    _addedNodes = uArray::New(::TYPES[71/*Fuse.Node[]*/], addedNodesCount);
    int addedNodesAt = 0;
    ...
    if (_useTemplates)
        ...
        {
            ::g::Fuse::Node* n1 = uAs< ::g::Fuse::Node*>(uPtr(_templates.Item(i2))->New1(), ::TYPES[25/*Fuse.Node*/]);

            if (n1 == NULL)
            {
                ::g::Fuse::Diagnostics::InternalError(uString::Const("Template contains a non-Node"), this, uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/NodeGroup.uno"), 194, uString::Const("AddContent"));
    ...
    uPtr(Parent())->InsertNodesAfter(this, (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), _addedNodes)), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL))));
}
...
uObject* NodeGroupBase::Nodes()
{
    if (_nodes == NULL)
    {
        _nodes = ((::g::Uno::Collections::RootableList*)::g::Uno::Collections::RootableList::New1(::g::Uno::Collections::RootableList_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)));
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/OrthographicFrustum.uno
// ----------------------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.ScriptClass.uno
// ---------------------------------------------------------------------
...
{
    ::g::Uno::UX::Selector_typeof()->Init();
    Visual__ParameterProperty::_name1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[60/*"Parameter"*/]);
}

static void Visual__ParameterProperty_build(uType* type)
{
    ::STRINGS[60] = uString::Const("Parameter");
...
{
    ::TYPES[59] = ::g::Fuse::IActualPlacement_typeof();
    ::TYPES[60] = ::g::Fuse::ITransformRelative_typeof();
    ::TYPES[61] = ::g::Fuse::PlacedHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::TranslationModes_typeof());
    type->SetInterfaces(
...
{
    uObject* n = uAs<uObject*>(uPtr(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/])))->Parent(), ::TYPES[59/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[59/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[61/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
...
{
    if (sub != NULL)
        ::g::Fuse::IActualPlacement::remove_Placed(uInterface(uPtr(uAs<uObject*>(sub, ::TYPES[59/*Fuse.IActualPlacement*/])), ::TYPES[59/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[61/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));
}
...
{
    ::STRINGS[36] = uString::Const("x");
    ::STRINGS[61] = uString::Const("y");
    ::STRINGS[62] = uString::Const("width");
    ::STRINGS[63] = uString::Const("height");
    ::TYPES[62] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    type->SetInterfaces(
...
{
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(serializer), ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[36/*"x"*/], (double)NewPosition().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[61/*"y"*/], (double)NewPosition().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[62/*"width"*/], (double)NewSize().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(serializer, ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[63/*"height"*/], (double)NewSize().Y);
}
...
{
    ::TYPES[63] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::IPreviewStateSaver_typeof(), NULL);
    ::TYPES[64] = ::g::Fuse::RootViewport_typeof();
    type->SetFields(0,
        ::g::Fuse::PreviewStateData_typeof(), offsetof(PreviewState, _current), 0,
        ::TYPES[63/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/], offsetof(PreviewState, _savers), 0);
}
...
uType* PreviewState_typeof()
{
    ...
    uTypeOptions options;
    options.FieldCount = 2;
    options.ObjectSize = sizeof(PreviewState);
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.PreviewState", options);
    type->fp_build_ = PreviewState_build;
    type->fp_ctor_ = (void*)PreviewState__New1_fn;
    return type;
}

// public generated PreviewState() :8
void PreviewState__ctor__fn(PreviewState* __this)
{
    __this->ctor_();
}

// public void AddSaver(Fuse.IPreviewStateSaver saver) :40
void PreviewState__AddSaver_fn(PreviewState* __this, uObject* saver)
{
    __this->AddSaver(saver);
}

// public Fuse.PreviewStateData get_Current() :35
void PreviewState__get_Current_fn(PreviewState* __this, ::g::Fuse::PreviewStateData** __retval)
{
    *__retval = __this->Current();
}

// public static Fuse.PreviewState Find(Fuse.Node n) :51
void PreviewState__Find_fn(::g::Fuse::Node* n, PreviewState** __retval)
{
    *__retval = PreviewState::Find(n);
}

// public generated PreviewState New() :8
void PreviewState__New1_fn(PreviewState** __retval)
{
    *__retval = PreviewState::New1();
}

// public void RemoveSaver(Fuse.IPreviewStateSaver saver) :45
void PreviewState__RemoveSaver_fn(PreviewState* __this, uObject* saver)
{
    __this->RemoveSaver(saver);
}

// public generated PreviewState() [instance] :8
void PreviewState::ctor_()
{
    _savers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[63/*Uno.Collections.List<Fuse.IPreviewStateSaver>*/]));
}

// public void AddSaver(Fuse.IPreviewStateSaver saver) [instance] :40
void PreviewState::AddSaver(uObject* saver)
{
    ::g::Uno::Collections::List__Add_fn(uPtr(_savers), saver);
}

// public Fuse.PreviewStateData get_Current() [instance] :35
::g::Fuse::PreviewStateData* PreviewState::Current()
{
    return _current;
}

// public void RemoveSaver(Fuse.IPreviewStateSaver saver) [instance] :45
void PreviewState::RemoveSaver(uObject* saver)
{
    bool ret2;
    ::g::Uno::Collections::List__Remove_fn(uPtr(_savers), saver, &ret2);
}

// public static Fuse.PreviewState Find(Fuse.Node n) [static] :51
PreviewState* PreviewState::Find(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        ::g::Fuse::RootViewport* rv = uAs< ::g::Fuse::RootViewport*>(n, ::TYPES[64/*Fuse.RootViewport*/]);

        if (rv != NULL)
            return uPtr(rv)->PreviewState();
...
// public generated PreviewState New() [static] :8
PreviewState* PreviewState::New1()
{
    PreviewState* obj1 = (PreviewState*)uNew(PreviewState_typeof());
    obj1->ctor_();
    return obj1;
}
// }
...
// {
static void PreviewStateData_build(uType* type)
{
    type->SetFields(0,
        ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), PreviewStateData__Entry_typeof(), NULL), offsetof(PreviewStateData, _data), 0);
}
...
uType* PreviewStateData_typeof()
{
    ...
    uTypeOptions options;
    options.FieldCount = 1;
    options.ObjectSize = sizeof(PreviewStateData);
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.PreviewStateData", options);
    type->fp_build_ = PreviewStateData_build;
    return type;
}

// public object Consume(string key) :93
void PreviewStateData__Consume_fn(PreviewStateData* __this, uString* key, uObject** __retval)
{
    *__retval = __this->Consume(key);
}

// public object Consume(string key) [instance] :93
uObject* PreviewStateData::Consume(uString* key)
{
    bool ret3;
    PreviewStateData__Entry* v;

    if ((::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(_data), key, (void**)(&v), &ret3), ret3) && !uPtr(v)->Consumed)
    {
        uPtr(v)->Consumed = true;
        return v->Data;
    }
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Ray.uno
// -------------------------------------------------------
...
// public generated RootViewHost() :16
void App__RootViewHost__ctor__fn(App__RootViewHost* __this)
{
    __this->ctor_();
}

// private void Fuse.Controls.INativeViewRoot.Add(Fuse.Controls.Native.ViewHandle handle) :18
...
{
    ::g::Fuse::Android::AppRoot::SetRootView(handle);
}

// private void Fuse.Controls.INativeViewRoot.Remove(Fuse.Controls.Native.ViewHandle handle) :19
...
{
    ::g::Fuse::Android::AppRoot::ClearRoot(handle);
}

// public generated RootViewHost New() :16
void App__RootViewHost__New1_fn(App__RootViewHost** __retval)
{
    *__retval = App__RootViewHost::New1();
}

// public generated RootViewHost() [instance] :16
void App__RootViewHost::ctor_()
{
}

// public generated RootViewHost New() [static] :16
...
{
    ::TYPES[66] = ::g::Fuse::IFrame_typeof();
    ::TYPES[23] = ::g::Uno::EventHandler_typeof();
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[67] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[68] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[69] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ...
    type->SetInterfaces(
        ...
        ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/], offsetof(RootViewport_type, interface10),
    ...
    type->SetFields(65,
        ::TYPES[66/*Fuse.IFrame*/], offsetof(RootViewport, _frame), 0,
        ...
        ::g::Fuse::PreviewState_typeof(), offsetof(RootViewport, _previewState), 0,
        ::TYPES[70/*Uno.Action<float2>*/], offsetof(RootViewport, Resized1), 0);
}
...
{
    for (::g::Fuse::Visual* v = (::g::Fuse::Visual*)__this->FirstChild(::TYPES[67/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (::g::Fuse::Visual*)uPtr(v)->NextSibling(::TYPES[68/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
        uPtr(v)->Draw(dc);
}
...
void RootViewport__UnoIDisposableDispose_fn(RootViewport* __this)
{
    ...
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(__this->Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]));
}
...
void RootViewport::ctor_3()
{
    ...
    _frustumViewport = ::g::Fuse::FrustumViewport::New1();
    _previewState = ::g::Fuse::PreviewState::New1();
...
void RootViewport::ctor_4(uObject* frame)
{
    ...
    ctor_2();
    _frame = frame;
    ::g::Fuse::IFrame::add_FrameChanged(uInterface(uPtr(_frame), ::TYPES[66/*Fuse.IFrame*/]), uDelegate::New(::TYPES[23/*Uno.EventHandler*/], (void*)RootViewport__OnResized_fn, this));
...
void RootViewport::EstablishSizeInternals()
{
    ...
    _pixelSize = ::g::Fuse::IFrame::Size(uInterface(uPtr(_frame), ::TYPES[66/*Fuse.IFrame*/]));
...
// internal Fuse.PreviewState get_PreviewState() [instance] :278
::g::Fuse::PreviewState* RootViewport::PreviewState()
{
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.Children.SafeIterator.uno
// -------------------------------------------------------------------------------
...
{
    ::TYPES[71] = ::g::Fuse::Node_typeof()->Array();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[71/*Fuse.Node[]*/], offsetof(Visual__SafeIterator, _array), 0,
...
void Visual__SafeIterator::SecureCopy()
{
    if (_array == NULL)
    {
        ...
        {
            _array = uArray::New(::TYPES[71/*Fuse.Node[]*/], uPtr(_v)->_childCount - _pos);
            int i = 0;
...
{
    ::TYPES[72] = ::g::Fuse::IScalingMode_typeof();
...
{
    return ::g::Fuse::IScalingMode::GetScaleVector(uInterface(uPtr((uObject*)RelativeTo()), ::TYPES[72/*Fuse.IScalingMode*/]), this);
}
...
{
    uObject* n = uAs<uObject*>(::g::Fuse::ITransformRelative::RelativeNode(uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/])), ::TYPES[59/*Fuse.IActualPlacement*/]);

    if (n != NULL)
        ::g::Fuse::IActualPlacement::add_Placed(uInterface(uPtr(n), ::TYPES[59/*Fuse.IActualPlacement*/]), uDelegate::New(::TYPES[61/*Fuse.PlacedHandler*/], uInterface(uPtr(transform), ::TYPES[60/*Fuse.ITransformRelative*/]), offsetof(::g::Fuse::ITransformRelative, fp_OnTransformChanged)));

    return ::g::Fuse::ITransformRelative::RelativeNode(uInterface(transform, ::TYPES[60/*Fuse.ITransformRelative*/]));
}
...
{
    ::TYPES[73] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::UpdateListener_typeof(), NULL);
    ::TYPES[74] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL)->Array();
    ::TYPES[75] = ::g::Uno::Collections::Queue_typeof()->MakeType(::g::Fuse::UpdateAction_typeof(), NULL);
    type->SetFields(0,
        ::g::Fuse::UpdateStage_typeof(), offsetof(Stage, UpdateStage), 0,
        ::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Listeners), 0,
        ::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, Onces), 0,
        ::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/], offsetof(Stage, OncesPending), 0,
        ::TYPES[74/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], offsetof(Stage, PhaseDeferredActions), 0,
...
{
    Listeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    Onces = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    OncesPending = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[73/*Uno.Collections.List<Fuse.UpdateListener>*/]));
    UpdateStage = _updateStage;
    int queueCount = 6;
    PhaseDeferredActions = uArray::New(::TYPES[74/*Uno.Collections.Queue<Fuse.UpdateAction>[]*/], queueCount);

    for (int i = 0; i < queueCount; ++i)
        uPtr(PhaseDeferredActions)->Strong< ::g::Uno::Collections::Queue*>(i) = (::g::Uno::Collections::Queue*)::g::Uno::Collections::Queue::New1(::TYPES[75/*Uno.Collections.Queue<Fuse.UpdateAction>*/]);
}
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/SystemFont.uno
// --------------------------------------------------------------
...
{
    ::TYPES[76] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::UX::Template_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[76/*Uno.Collections.List<Uno.UX.Template>*/], offsetof(TemplateSourceImpl, _templates), 0);
}
...
{
    if (_templates == NULL)
        _templates = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[76/*Uno.Collections.List<Uno.UX.Template>*/]));
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/Time.uno
// --------------------------------------------------------
...
{
    ::TYPES[77] = ::g::Uno::Action1_typeof()->MakeType(type, NULL);
    type->SetInterfaces(
    ...
    type->SetFields(15,
        ::TYPES[77/*Uno.Action<Fuse.Transform>*/], offsetof(Transform, MatrixChanged1), 0);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(MatrixChanged1, value), ::TYPES[77/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    MatrixChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(MatrixChanged1, value), ::TYPES[77/*Uno.Action<Fuse.Transform>*/]);
}
...
{
    ::TYPES[78] = ::g::Fuse::ITranslationMode_typeof();
...
{
    float weight_ = *weight;
    ::g::Uno::Float3 v = ::g::Uno::Float3__op_Multiply1(::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[78/*Fuse.ITranslationMode*/]), __this), weight_);
...
{
    ::g::Uno::Float3 v = ::g::Fuse::ITranslationMode::GetAbsVector(uInterface(uPtr((uObject*)__this->RelativeTo()), ::TYPES[78/*Fuse.ITranslationMode*/]), __this);
...
{
    uObject* isz = uAs<uObject*>(node, ::TYPES[59/*Fuse.IActualPlacement*/]);

    if (isz == NULL)
        return ::g::Uno::Float3__New1(0.0f);

    return ::g::Fuse::IActualPlacement::ActualSize(uInterface(uPtr(isz), ::TYPES[59/*Fuse.IActualPlacement*/]));
}
// }

// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/VisualBounds.uno
// ---------------------------------------------------------------
...
{
    ::TYPES[79] = ::g::Fuse::IUpdateListener_typeof();
    type->SetFields(0,
        ::g::Uno::Action_typeof(), offsetof(UpdateAction, action), 0,
        ::TYPES[79/*Fuse.IUpdateListener*/], offsetof(UpdateAction, update), 0);
}
...
void UpdateAction::Invoke()
{
    ...
    if (update != NULL)
        ::g::Fuse::IUpdateListener::Update(uInterface(uPtr(update), ::TYPES[79/*Fuse.IUpdateListener*/]));
}
...
static void UpdateListener_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[79/*Fuse.IUpdateListener*/], offsetof(UpdateListener, update), 0,
...
{
    UpdateManager::_stages_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[80/*Uno.Collections.List<Fuse.Stage>*/]));
    UpdateManager::_postActions_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[81/*Uno.Collections.List<Uno.Action>*/]));
    UpdateManager::_postActionsSwap_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[81/*Uno.Collections.List<Uno.Action>*/]));
...
static void UpdateManager_build(uType* type)
{
    ...
    ::TYPES[80] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Stage_typeof(), NULL);
    ::TYPES[81] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof(), NULL);
    ::TYPES[39] = ::g::Uno::Exception_typeof();
    ::TYPES[82] = ::g::Uno::Collections::List_typeof()->MakeType(::TYPES[39/*Uno.Exception*/], NULL);
    type->SetFields(0,
        ::TYPES[80/*Uno.Collections.List<Fuse.Stage>*/], (uintptr_t)&UpdateManager::_stages_, uFieldFlagsStatic,
        ::TYPES[81/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActions_, uFieldFlagsStatic,
        ::TYPES[81/*Uno.Collections.List<Uno.Action>*/], (uintptr_t)&UpdateManager::_postActionsSwap_, uFieldFlagsStatic,
...
// internal static Fuse.UpdateStage get_CurrentStage() :327
...
// public static void PerformNextFrame(Uno.Action pu, [Fuse.UpdateStage stage], [int deferFrame]) :233
void UpdateManager__PerformNextFrame_fn(uDelegate* pu, int* stage, int* deferFrame)
{
    UpdateManager::PerformNextFrame(pu, *stage, *deferFrame);
}
...
// public static void PerformNextFrame(Uno.Action pu, [Fuse.UpdateStage stage], [int deferFrame]) [static] :233
void UpdateManager::PerformNextFrame(uDelegate* pu, int stage, int deferFrame)
{
    UpdateManager_typeof()->Init();
    ::g::Fuse::Stage* ret8;
    ::g::Fuse::UpdateListener* us = ::g::Fuse::UpdateListener::New1();
    us->action = pu;
    us->deferFrame = (UpdateManager::FrameIndex() + deferFrame);
...
void UpdateManager::ProcessDeferredActions(::g::Fuse::Stage* stage, ::g::Uno::Collections::List** _exceptions)
{
    ...
    for (::g::Fuse::UpdateAction* a = uPtr(stage)->GetFirstPriorityAction(); a != NULL; a = stage->GetFirstPriorityAction())
        ...
        catch (const uThrowable& __t)
        {
            ...
            if (*_exceptions == NULL)
                *_exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[82/*Uno.Collections.List<Uno.Exception>*/]);
...
// internal static Fuse.UpdateStage get_CurrentStage() [static] :327
int UpdateManager::CurrentStage()
{
    UpdateManager_typeof()->Init();
    return (UpdateManager::_currentStage_ == NULL) ? -1 : uPtr(UpdateManager::_currentStage_)->UpdateStage;
}
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.ScriptClass.uno
// -----------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[83/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[84/*Fuse.Scripting.ScriptMethod<Fuse.UserEvent>*/], ::STRINGS[65/*"raise"*/], uDelegate::New(::TYPES[85/*Uno.Action<Fuse.Scripting.Context, Fuse.UserEvent, object[]>*/], (void*)UserEvent__raise_fn), 2)));
}
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[67] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.uno");
    ...
    ::STRINGS[70] = uString::Const("/usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.ScriptClass.uno");
    ::STRINGS[71] = uString::Const("Raise must be called with a JavaScript object to define name/value pairs");
    ::STRINGS[72] = uString::Const("Trying to Raise on unrooted UserEvent");
    ::STRINGS[73] = uString::Const("Raise");
    ::TYPES[26] = ::g::Uno::Type_typeof();
    ::TYPES[83] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ::TYPES[84] = ::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(type, NULL);
    ::TYPES[85] = ::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), type, uObject_typeof()->Array(), NULL);
    ::TYPES[86] = ::g::Fuse::Scripting::Object_typeof();
    ::TYPES[87] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[88] = ::TYPES[6/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.UserEvent>*/, type, NULL);
    ::TYPES[89] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.UserEvent>*/, type, NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
        ::g::Uno::UX::Selector_typeof(),
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[66/*"UserEvent r...*/], __this, ::STRINGS[67/*"/usr/local/...*/], 206, ::STRINGS[68/*"OnRooted"*/], NULL);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[72/*"Trying to R...*/], this, ::STRINGS[67/*"/usr/local/...*/], 252, ::STRINGS[73/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[69/*"Raise must ...*/], n, ::STRINGS[70/*"/usr/local/...*/], 76, ::STRINGS[65/*"raise"*/], NULL);
        return;
    }

    ::g::Fuse::Scripting::Object* so = uAs< ::g::Fuse::Scripting::Object*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[86/*Fuse.Scripting.Object*/]);

    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[71/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[70/*"/usr/local/...*/], 83, ::STRINGS[65/*"raise"*/], NULL);
        return;
    }

    uArray* keys = uPtr(so)->Keys();
    ::g::Uno::Collections::Dictionary* evArgs = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[87/*Uno.Collections.Dictionary<string, object>*/]);
...
UserEvent* UserEvent::ScanTree(::g::Fuse::Node* at, ::g::Uno::UX::Selector name, ::g::Fuse::Visual** visual)
{
    ...
    while (at != NULL)
    {
        ...
        if (v != NULL)
            ...
            for (UserEvent* ue = (UserEvent*)uPtr(v)->FirstChild(::TYPES[88/*Fuse.Visual.FirstChild<Fuse.UserEvent>*/]); ue != NULL; ue = (UserEvent*)uPtr(ue)->NextSibling(::TYPES[89/*Fuse.Node.NextSibling<Fuse.UserEvent>*/]))
...
// /usr/local/share/uno/Packages/Fuse.UserEvents/1.4.2/UserEvent.uno
// -----------------------------------------------------------------
...
static void UserEventArgs_build(uType* type)
{
    ...
    ::TYPES[62] = ::g::Fuse::Scripting::IEventSerializer_typeof();
    ::TYPES[90] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    ::TYPES[91] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::UX::Selector_typeof());
    type->SetInterfaces(
...
void UserEventArgs__FuseScriptingIScriptEventSerialize_fn(UserEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[74/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->Dispatch())->Name()));
    ...
    if (__this->Args() != NULL)
    {
        ...
        {
            {
                while (enum1.MoveNext(::TYPES[90/*Uno.Collections.Dictionary<string, object>.Enumerator*/]))
                {
                    ...
                    ::g::Fuse::Scripting::IEventSerializer::AddObject(uInterface(uPtr(s), ::TYPES[62/*Fuse.Scripting.IEventSerializer*/]), m.Key(::TYPES[91/*Uno.Collections.KeyValuePair<string, object>*/]), m.Value(::TYPES[91/*Uno.Collections.KeyValuePair<string, object>*/]));
                }
            }
            {
                enum1.Dispose(::TYPES[90/*Uno.Collections.Dictionary<string, object>.Enumerator*/]);
            }
        }
...
{
    ::TYPES[92] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::UX::Selector_typeof(), type, NULL);
    ::TYPES[2] = ::g::Uno::Action_typeof();
    ::TYPES[93] = ::g::Fuse::UserEventHandler_typeof();
    type->SetFields(0,
        ::g::Uno::UX::Selector_typeof(), offsetof(UserEventDispatch, _Name), 0,
        ::TYPES[93/*Fuse.UserEventHandler*/], offsetof(UserEventDispatch, Raised1), 0,
        ::TYPES[92/*Uno.Collections.Dictionary<Uno.UX.Selector, Fuse.UserEventDispatch>*/], (uintptr_t)&UserEventDispatch::_userEvents_, uFieldFlagsStatic);
}
...
{
    ::g::Fuse::UserEventArgs* m = ::g::Fuse::UserEventArgs::New2(this, source, args);
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)::g::Fuse::UserEventArgs__Raise_fn, m), -1, 2);
}
...
static void Visual__cctor_1_fn(uType* __type)
{
    ...
    Visual::ParameterName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[60/*"Parameter"*/]);
    Visual::_resourcesHandle_ = ::g::Fuse::Properties::CreateHandle();
    Visual::_emptyVisuals_ = uArray::New(__type->Array(), 0);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[83/*Fuse.Scripting.ScriptMember[]*/], 3, (::g::Fuse::Scripting::ScriptProperty1*)::g::Fuse::Scripting::ScriptProperty1::New1(::g::Fuse::Scripting::ScriptProperty1_typeof()->MakeType(__type, ::TYPES[27/*string*/], NULL), ::STRINGS[60/*"Parameter"*/], uDelegate::New(::g::Uno::Func1_typeof()->MakeType(__type, ::g::Uno::UX::Property1_typeof()->MakeType(::TYPES[27/*string*/], NULL), NULL), (void*)Visual__getParameterProperty_fn), uString::Const(".notNull().parseJson()")), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("onParameterChanged"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], NULL), (void*)Visual__onParameterChanged_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("bringIntoView"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[11/*object[]*/], NULL), (void*)Visual__bringIntoView_fn), 2)));
}
...
// public void add_IsContextEnabledChanged(Uno.EventHandler value) :15
void Visual__add_IsContextEnabledChanged_fn(Visual* __this, uDelegate* value)
{
    __this->add_IsContextEnabledChanged(value);
}

// public void remove_IsContextEnabledChanged(Uno.EventHandler value) :16
...
void Visual__OnArrangeMarginBox_fn(Visual* __this, ::g::Uno::Float2* position, ::g::Fuse::LayoutParams* lp, ::g::Uno::Float2* __retval)
{
    ...
    for (Visual* v = (Visual*)__this->FirstChild(::TYPES[67/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[68/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
    {
...
void Visual__OnChildAdded_fn(Visual* __this, ::g::Fuse::Node* elm)
{
    if ((__this->_observerCount != 0) && __this->IsRootingStarted())
        ...
        for (::g::Fuse::Node* n = (::g::Fuse::Node*)__this->FirstChild(Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Node>*/, ::TYPES[25/*Fuse.Node*/], NULL)); n != NULL; n = (::g::Fuse::Node*)uPtr(n)->NextSibling(::TYPES[25/*Fuse.Node*/]->MakeMethod(3/*NextSibling<Fuse.Node>*/, ::TYPES[25/*Fuse.Node*/], NULL)))
        {
...
void Visual__OnRooted_fn(Visual* __this)
{
    ...
    {
        uObject* enum4 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Children()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)));

        try
        {
            {
                while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum4), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
                {
                    ::g::Fuse::Node* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum4), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret28), ret28);
            ...
            {
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum4), ::TYPES[31/*Uno.IDisposable*/]));
            }
        }
...
void Visual__OnUnrooted_fn(Visual* __this)
{
    ...
    if (__this->HasChildren())
    {
        uObject* enum5 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(__this->Children()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)));

        try
        {
            {
                while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum5), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
                {
                    ::g::Fuse::Node* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum5), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret29), ret29);
                    uPtr(c)->UnrootInternal();
                }
            }
            {
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum5), ::TYPES[31/*Uno.IDisposable*/]));
            }
        }
...
// internal void Prepare(string parameter) :101
...
void Visual__UnoCollectionsIListFuseNodeRemoveAt_fn(Visual* __this, int* index)
{
    ::g::Fuse::Node* ret35;
    int index_ = *index;
    ::g::Fuse::Node* b = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->Children()), ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), uCRef<int>(index_), &ret35), ret35);
...
{
    _worldTransformInvalidated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(_worldTransformInvalidated1, value), ::TYPES[23/*Uno.EventHandler*/]);
}
...
{
    _worldTransformInvalidated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(_worldTransformInvalidated1, value), ::TYPES[23/*Uno.EventHandler*/]);
}
...
void Visual::AddParameterChangedListener(::g::Fuse::Scripting::Function* func)
{
    if (_parameterListeners == NULL)
        _parameterListeners = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List`1*/]->MakeType(::g::Fuse::Scripting::Function_typeof(), NULL)));
    ...
    if (::g::Uno::String::op_Inequality(_parameter, NULL))
    {
        ...
        if (so != NULL)
            uPtr(func)->Call(uArray::Init<uObject*>(::TYPES[11/*object[]*/], 1, (uObject*)uPtr(::g::Fuse::Scripting::IScriptObject::ScriptContext(uInterface(uPtr(so), ::g::Fuse::Scripting::IScriptObject_typeof())))->ParseJson(_parameter)));
    }
}
...
void Visual::AssignNaturalZOrder()
{
    ...
    for (Visual* v = (Visual*)FirstChild(::TYPES[67/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)uPtr(v)->NextSibling(::TYPES[68/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
void Visual::BeginRemoveChild(::g::Fuse::Node* n, uDelegate* then)
{
    ...
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), n, &ret9);
...
void Visual::BeginRemoveVisual(Visual* child, uDelegate* then)
{
    ...
    if (!IsRootingCompleted())
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret10);
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), child, &ret11), ret11))
        return;
...
{
    for (::g::Fuse::Transform* t = (::g::Fuse::Transform*)FirstChild(Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Transform>*/, ::g::Fuse::Transform_typeof(), NULL)); t != NULL; t = (::g::Fuse::Transform*)uPtr(t)->NextSibling(::TYPES[25/*Fuse.Node*/]->MakeMethod(3/*NextSibling<Fuse.Transform>*/, ::g::Fuse::Transform_typeof(), NULL)))
        if (!uPtr(t)->IsFlat())
            return false;
...
void Visual::CancelInteractions(int how)
{
    ...
    if (_interactions != NULL)
    {
        ::g::Uno::Collections::List* ids = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[94/*Uno.Collections.List`1*/]->MakeType(uObject_typeof(), NULL));
    ...
    if (how == 1)
        ...
        for (Visual* v = (Visual*)FirstChild(::TYPES[67/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); v != NULL; v = (Visual*)NextSibling(::TYPES[68/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
...
void Visual::Children_Add(::g::Fuse::Node* n)
{
    ...
    else
    {
        ...
        uPtr(n)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), _lastChild);
        _lastChild = n;
    }
...
void Visual::Children_Clear()
{
    ...
    for (::g::Fuse::Node* c = _firstChild; c != NULL; c = nextSibling)
    {
        ...
        c->_nextSibling = NULL;
        c->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), NULL);
    }
...
uArray* Visual::Children_GetCachedArray()
{
    ...
    uArray* nodes = uArray::New(::TYPES[71/*Fuse.Node[]*/], _childCount);
...
void Visual::Children_InsertAfter(::g::Fuse::Node* preceeder, ::g::Fuse::Node* newNode)
{
    ...
    if (preceeder == NULL)
    {
        ...
        else
        {
            ...
            uPtr(_firstChild)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), newNode);
            _firstChild = newNode;
            _childCount++;
    ...
    else
    {
        ...
        {
            Children_MakeParent(this, newNode);
            uPtr(newNode)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), preceeder);
            newNode->_nextSibling = uPtr(preceeder)->_nextSibling;
            uPtr(preceeder->_nextSibling)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), newNode);
...
bool Visual::Children_Remove(::g::Fuse::Node* n)
{
    ...
    if (_firstChild == n)
    {
        ...
        if (_firstChild != NULL)
            uPtr(_firstChild)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), NULL);
    ...
    {
        _lastChild = ((::g::Fuse::Node*)::g::Fuse::Internal::RawPointer::op_Explicit1(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), uPtr(n)->_previousSibling));
    ...
    {
        uPtr((::g::Fuse::Node*)::g::Fuse::Internal::RawPointer::op_Explicit1(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), uPtr(n)->_previousSibling))->_nextSibling = uPtr(n)->_nextSibling;
        uPtr(n->_nextSibling)->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), (::g::Fuse::Node*)::g::Fuse::Internal::RawPointer::op_Explicit1(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), n->_previousSibling));
    }

    uPtr(n)->_nextSibling = NULL;
    n->_previousSibling = ::g::Fuse::Internal::RawPointer::op_Implicit(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), NULL);
    _childCount--;
...
uArray* Visual::ComputeZOrder()
{
    ...
    if (_visualChildCount == 1)
        return uArray::Init<Visual*>(Visual_typeof()->Array(), 1, (Visual*)FirstChild(::TYPES[67/*Fuse.Visual.FirstChild<Fuse.Visual>*/]));
    ...
    for (Visual* v = (Visual*)LastChild(Visual_typeof()->MakeMethod(7/*LastChild<Fuse.Visual>*/, Visual_typeof(), NULL)); v != NULL; v = (Visual*)uPtr(v)->PreviousSibling(::TYPES[25/*Fuse.Node*/]->MakeMethod(4/*PreviousSibling<Fuse.Visual>*/, Visual_typeof(), NULL)), i++)
    {
...
void Visual::ConcludePendingRemove()
{
    ...
    if (HasBit(268435456))
    {
        ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::TYPES[69/*Uno.Collections.ICollection<Fuse.Node>*/]), this, &ret16);
        SetBit1(268435456, false);
    }
}
...
void Visual::InsertNodesAfterImpl(::g::Fuse::Node* preceeder, uObject* items, bool allowMove)
{
    ...
    while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(items), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
        InsertCleanup((::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret22), ret22));
    ...
    {
        {
            ...
            {
                ::g::Fuse::Node* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret23), ret23);
                ...
                if (allowMove)
                {
                    if (Children_Contains(c))
                    {
                        ...
                        if (moved == NULL)
                            moved = (::g::Uno::Collections::HashSet*)::g::Uno::Collections::HashSet::New1(::g::Uno::Collections::HashSet_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL));
            ...
            while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(items, ::TYPES[29/*Uno.Collections.IEnumerator*/])))
            {
                ::g::Fuse::Node* c1 = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(items), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret25), ret25);
...
{
    uPtr(uCast<uDelegate*>(obj, ::TYPES[23/*Uno.EventHandler*/]))->Invoke(2, this, uCast< ::g::Uno::EventArgs*>(args, ::g::Uno::EventArgs_typeof()));
}
...
// public void add_IsContextEnabledChanged(Uno.EventHandler value) [instance] :15
void Visual::add_IsContextEnabledChanged(uDelegate* value)
{
    AddEventHandler(Visual::_isContextEnabledChangedHandle_, 4, value);
}

// public void remove_IsContextEnabledChanged(Uno.EventHandler value) [instance] :16
void Visual::remove_IsContextEnabledChanged(uDelegate* value)
{
    RemoveEventHandler(Visual::_isContextEnabledChangedHandle_, 4, value);
}
...
::g::Fuse::Node* Visual::LastChild(uType* __type)
{
    ...
    while (c != NULL)
    {
        ...
        c = (::g::Fuse::Node*)::g::Fuse::Internal::RawPointer::op_Explicit1(::g::Fuse::Internal::RawPointer_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL), uPtr(c)->_previousSibling);
    }
...
void Visual::OnBeginRemoveVisual(::g::Fuse::PendingRemoveVisual* args)
{
    ...
    for (::g::Fuse::Node* n = (::g::Fuse::Node*)FirstChild(Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Node>*/, ::TYPES[25/*Fuse.Node*/], NULL)); n != NULL; n = (::g::Fuse::Node*)uPtr(n)->NextSibling(::TYPES[25/*Fuse.Node*/]->MakeMethod(3/*NextSibling<Fuse.Node>*/, ::TYPES[25/*Fuse.Node*/], NULL)))
    {
    ...
    if (_parameterListeners != NULL)
    {
        ...
        if (so != NULL)
        {
            ...
            for (int i = 0; i < uPtr(_parameterListeners)->Count(); i++)
                uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_parameterListeners), uCRef<int>(i), &ret27), ret27))->Call(uArray::Init<uObject*>(::TYPES[11/*object[]*/], 1, param));
        }
    }
...
{
    _transformCount++;
    uPtr(t)->add_MatrixChanged(uDelegate::New(::TYPES[77/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
{
    _transformCount--;
    uPtr(t)->remove_MatrixChanged(uDelegate::New(::TYPES[77/*Uno.Action<Fuse.Transform>*/], (void*)Visual__OnMatrixChanged_fn, this));
    OnMatrixChanged(t);
}
...
// internal void Prepare(string parameter) [instance] :101
...
{
    ::g::Fuse::Node* ret30;
    uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(Children()), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)));
    ...
    {
        {
            while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
            {
                ::g::Fuse::Node* c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[25/*Fuse.Node*/], NULL)), &ret30), ret30);
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.EventStorage.uno
// ----------------------------------------------------------------------
...
VisualBounds* VisualBounds::Merge1(uObject* visuals, int bt)
{
    ...
    uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(visuals), ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::TYPES[6/*Fuse.Visual*/], NULL)));
    ...
    {
        {
            while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[29/*Uno.Collections.IEnumerator*/])))
            {
                ::g::Fuse::Visual* elm = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[6/*Fuse.Visual*/], NULL)), &ret5), ret5);
                ...
                {
                    VisualBounds* __uno_retval = VisualBounds::Infinite();
                    ::g::Uno::IDisposable::Dispose(uInterface(uPtr(enum1), ::TYPES[31/*Uno.IDisposable*/]));
                    return __uno_retval;
                }
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Visual.uno
// ---------------------------------------------------------
...
// /usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Event.uno
// --------------------------------------------------------
...
{
    ::STRINGS[75] = uString::Const("Invalid RaiseType for event");
    ::STRINGS[76] = uString::Const("/usr/local/share/uno/Packages/Fuse.Nodes/1.4.2/Event.uno");
    ::TYPES[94] = ::g::Uno::Collections::List_typeof();
    ::TYPES[39] = ::g::Uno::Exception_typeof();
    ::TYPES[6] = ::g::Fuse::Visual_typeof();
    ::TYPES[95] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), uObject_typeof()->Array(), NULL);
    ::TYPES[11] = uObject_typeof()->Array();
    type->SetDependencies(
        ::g::Fuse::AppBase_typeof(),
        ::g::Uno::Diagnostics::Debug_typeof(),
    ...
    type->SetFields(0,
        ...
        ::TYPES[94/*Uno.Collections.List`1*/]->MakeType(type->T(0), NULL), offsetof(VisualEvent, _globalHandlers), 0);
}
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        case 0:
        {
            handler = uDelegate::New(::TYPES[95/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaise_fn, this);
            break;
        }
        case 2:
        {
        ...
        case 1:
        {
            handler = uDelegate::New(::TYPES[95/*Uno.Action<object, object[]>*/], (void*)VisualEvent__OnRaiseEnabled_fn, this);
            break;
        }
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[75/*"Invalid Rai...*/], 0, ::STRINGS[76/*"/usr/local/...*/], 105);
            return;
        }
    }
...
{
    VisualListCache::_visualListCache_ = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[96/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/]));
}

static void VisualListCache_build(uType* type)
{
    ::TYPES[96] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), NULL);
    ::TYPES[0] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    type->SetFields(0,
        ::TYPES[96/*Uno.Collections.List<Uno.Collections.List<Fuse.Visual>>*/], (uintptr_t)&VisualListCache::_visualListCache_, uFieldFlagsStatic);
}
...
// /usr/local/share/uno/Packages/Fuse.Common/1.4.2/WrapException.uno
// -----------------------------------------------------------------
