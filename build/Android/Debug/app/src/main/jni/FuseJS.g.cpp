...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/Base64.uno
// -----------------------------------------------------
...
static void Base64_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(0/*FirstOrDefault<object>*/, uObject_typeof(), NULL);
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/Bundle.uno
// -----------------------------------------------------
...
::g::Uno::Threading::Future1* Bundle::Extract(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(destinationPath, ::STRINGS[23/*""*/]))
...
::g::Uno::Threading::Future1* Bundle::ReadAsync(uArray* args)
{
    if (uPtr(args)->Length() > 0)
    {
        ...
        return Bundle::ReadAsync1((filename != NULL) ? filename : ::STRINGS[23/*""*/]);
    }
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/Environment.uno
// ----------------------------------------------------------
...
static void Environment_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("host_mac");
    ::STRINGS[22] = uString::Const("mobileOSVersion");
...
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[5/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[15/*"android"*/], uCRef(true), &ret2), ret2));
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[5/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[16/*"ios"*/], uCRef(false), &ret3), ret3));
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[5/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[21/*"host_mac"*/], uCRef(true), &ret8), ret8));
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/FileReader.uno
// ---------------------------------------------------------
...
static void FileReaderImpl__FileReadCommand_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("jpeg");
    ::STRINGS[27] = uString::Const("data:image/");
    ::STRINGS[28] = uString::Const(";base64,");
    type->SetFields(0,
...
uString* FileReaderImpl__FileReadCommand::ReadAsDataURL()
{
    ...
    uString* type = ::g::Uno::String::EndsWith(uPtr(::g::Uno::String::ToUpper(uPtr(_path))), ::STRINGS[24/*"PNG"*/]) ? ::STRINGS[25/*"png"*/] : ::STRINGS[26/*"jpeg"*/];
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/Globals.uno
// ------------------------------------------------------
...
{
    ::STRINGS[29] = uString::Const("FuseJS/Globals");
    ::STRINGS[30] = uString::Const("readAsText");
    ::STRINGS[31] = uString::Const("Globals.readAsText(): Exactly one argument expected");
    ::STRINGS[32] = uString::Const("Globals.readAsText(): Argument must be string");
    ::STRINGS[33] = uString::Const("Globals.readAsText(): Global resource file '");
    ::STRINGS[34] = uString::Const("' not found");
...
void Globals::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Globals::_instance_ = this, ::STRINGS[29/*"FuseJS/Glob...*/]);
...
uString* Globals::readAsText(uArray* args)
{
    ...
    if (args->Length() != 1)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[32/*"Globals.rea...*/]));
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[33/*"Globals.rea...*/], key), ::STRINGS[34/*"' not found"*/])));
}
// }

// /usr/local/share/uno/Packages/FuseJS/1.4.2/Latin1Helpers.uno
// ------------------------------------------------------------
...
{
    ::STRINGS[35] = uString::Const("The string to be encoded contains characters outside of the Latin1 range.");
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/Lifecycle.uno
// --------------------------------------------------------
...
{
    ::STRINGS[36] = uString::Const("enteringInteractive");
    ::STRINGS[37] = uString::Const("exitedInteractive");
    ::STRINGS[38] = uString::Const("enteringForeground");
    ::STRINGS[39] = uString::Const("enteringBackground");
    ::STRINGS[40] = uString::Const("stateChanged");
    ::STRINGS[41] = uString::Const("FuseJS/Lifecycle");
    ::STRINGS[42] = uString::Const("onEnteringInteractive");
    ::STRINGS[43] = uString::Const("onEnteringForeground");
    ::STRINGS[44] = uString::Const("onEnteringBackground");
    ::STRINGS[45] = uString::Const("onExitedInteractive");
    ::STRINGS[46] = uString::Const("state");
    ::STRINGS[47] = uString::Const("BACKGROUND");
    ::STRINGS[48] = uString::Const("FOREGROUND");
    ::STRINGS[49] = uString::Const("INTERACTIVE");
...
void Lifecycle::ctor_3()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(Lifecycle::_instance_ = this, ::STRINGS[41/*"FuseJS/Life...*/]);
    ::g::Fuse::Scripting::NativeEvent* onEnteringInteractive = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[42/*"onEnteringI...*/], true);
    ::g::Fuse::Scripting::NativeEvent* onEnteringForeground = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[43/*"onEnteringF...*/], true);
    ::g::Fuse::Scripting::NativeEvent* onEnteringBackground = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[44/*"onEnteringB...*/], true);
    ::g::Fuse::Scripting::NativeEvent* onExitedInteractive = ::g::Fuse::Scripting::NativeEvent::New4(::STRINGS[45/*"onExitedInt...*/], true);
    On1(::STRINGS[36/*"enteringInt...*/], onEnteringInteractive);
    On1(::STRINGS[38/*"enteringFor...*/], onEnteringForeground);
    On1(::STRINGS[39/*"enteringBac...*/], onEnteringBackground);
    On1(::STRINGS[37/*"exitedInter...*/], onExitedInteractive);
    _state = ((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[14/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[46/*"state"*/], uDelegate::New(::TYPES[15/*Uno.Func<int>*/], (void*)Lifecycle__GetCurrentState_fn), NULL, uDelegate::New(::TYPES[16/*Fuse.Scripting.ValueConverter<int, int>*/], (void*)Lifecycle__Converter_fn)));
    _background = ((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[14/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[47/*"BACKGROUND"*/], uDelegate::New(::TYPES[15/*Uno.Func<int>*/], (void*)Lifecycle__GetApplicationStateBackground_fn), NULL, NULL));
    _foreground = ((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[14/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[48/*"FOREGROUND"*/], uDelegate::New(::TYPES[15/*Uno.Func<int>*/], (void*)Lifecycle__GetApplicationStateForeground_fn), NULL, NULL));
    _interactive = ((::g::Fuse::Scripting::NativeProperty*)::g::Fuse::Scripting::NativeProperty::New2(::TYPES[14/*Fuse.Scripting.NativeProperty<int, int>*/], ::STRINGS[49/*"INTERACTIVE"*/], uDelegate::New(::TYPES[15/*Uno.Func<int>*/], (void*)Lifecycle__GetApplicationStateInteractive_fn), NULL, NULL));
    AddMember(_state);
...
// /usr/local/share/uno/Packages/FuseJS/1.4.2/UserEvents.uno
// ---------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("/usr/local/share/uno/Packages/FuseJS/1.4.2/UserEvents.uno");
...
void UserEvents::ctor_2()
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(UserEvents::_instance_ = this, ::STRINGS[53/*"FuseJS/User...*/]);
