...
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* fuseplaceautocomplete_FuseControlsTextControl_Value_Property_typeof();}
namespace g{namespace Uno{namespace UX{struct Property1_type;}} ::g::Uno::UX::Property1_type* fuseplaceautocomplete_FuseReactiveEach_Items_Property_typeof();}
...
namespace g{namespace Uno{namespace Compiler{namespace ExportTargetInterop{uClassType* ForeignDataView_typeof();}}}}
...
namespace g{namespace Uno{namespace Platform{struct Display_type; ::g::Uno::Platform::Display_type* AndroidDisplay_typeof();}}}
...
namespace g{namespace Android{uClassType* ActivityUtils_typeof();}}
...
namespace g{namespace Fuse{uType* Computer_typeof();}}
namespace g{namespace Fuse{uType* Computer1_typeof();}}
...
namespace g{namespace Fuse{uType* PreviewStateData__Entry_typeof();}}
...
namespace g{namespace Fuse{uType* Float2Computer_typeof();}}
namespace g{namespace Fuse{uType* Float3Computer_typeof();}}
namespace g{namespace Fuse{uType* Float4Computer_typeof();}}
...
namespace g{namespace Fuse{uType* NumberComputer_typeof();}}
...
namespace g{namespace Fuse{uType* PreviewState_typeof();}}
namespace g{namespace Fuse{uType* PreviewStateData_typeof();}}
...
namespace g{namespace Fuse{uType* Size2Computer_typeof();}}
namespace g{namespace Fuse{uType* SizeComputer_typeof();}}
...
namespace g{namespace Fuse{uType* StringComputer_typeof();}}
...
namespace g{namespace Fuse{namespace Resources{namespace Exif{uType* ExifAndroidImpl_typeof();}}}}
namespace g{namespace Fuse{namespace Resources{namespace Exif{uStructType* ExifData_typeof();}}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* Observable__Subscription__ClearExclusiveOperation_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ThreadWorker__ContextIgnoringAction_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uClassType* DateTimeConverterHelpers_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Observable__Operation_type; ::g::Fuse::Scripting::Observable__Operation_type* Observable__Failed_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct FunctionMirror_type; FunctionMirror_type* FunctionMirror_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ThreadWorker__MethodClosure_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct Module_type; Module_type* Module_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ModuleInstance_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{struct Observable_type; Observable_type* Observable_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* ThreadWorker__PropertyClosure_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ObservableProperty__PushCapture_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ThreadWorker__ReadonlyPropertyClosure_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* Observable__Subscription__ReplaceAllExclusiveOperation_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{uType* ScriptModule__RequireContext_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct ScriptModule_type; ::g::Fuse::Scripting::ScriptModule_type* RootableScriptModule_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* Observable__Subscription__SetExclusiveOperation_typeof();}}}
...
namespace g{namespace Fuse{namespace Scripting{uType* SubscriptionSubject_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct ThreadWorker_type; ThreadWorker_type* ThreadWorker_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{struct TextEditRenderer__Renderer_type; TextEditRenderer__Renderer_type* TextEditRenderer__Renderer_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{struct ViewHandle_type;}}} namespace Fuse{namespace Controls{::g::Fuse::Controls::Native::ViewHandle_type* TreeRenderer__ViewGroup_typeof();}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace Android{struct CanvasViewGroup_type; CanvasViewGroup_type* CanvasViewGroup_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace Android{struct GraphicsViewBase_type; GraphicsViewBase_type* GraphicsViewBase_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Controls{namespace Native{namespace Android{struct GraphicsViewBase_type; ::g::Fuse::Controls::Native::Android::GraphicsViewBase_type* TextureView_typeof();}}}}}
...
namespace g{namespace Fuse{namespace Reactive{struct Expression_type; ::g::Fuse::Reactive::Expression_type* BinaryOperator_typeof();}}}
...
namespace g{namespace Fuse{namespace Reactive{struct InnerListener_type; ::g::Fuse::Reactive::InnerListener_type* UnaryOperator__Subscription_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{uType* AndroidCanvasPath_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{uType* AndroidGraphicsDrawHelper_typeof();}}}
namespace g{namespace Fuse{namespace Drawing{struct AndroidSurface_type; AndroidSurface_type* AndroidSurface_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{struct AndroidSurface_type; ::g::Fuse::Drawing::AndroidSurface_type* GraphicsSurface_typeof();}}}
...
namespace g{namespace Fuse{namespace Drawing{struct AndroidSurface_type; ::g::Fuse::Drawing::AndroidSurface_type* NativeSurface_typeof();}}}
...
namespace g{namespace Fuse{namespace Navigation{uType* RouterPageRoute_typeof();}}}
...
namespace g{namespace Uno{namespace Threading{struct Future_type;}} namespace Fuse{namespace PlaceAutocomple{::g::Uno::Threading::Future_type* Launch_typeof();}}}
namespace g{namespace Fuse{namespace Scripting{struct NativeModule_type;}} namespace Fuse{namespace PlaceAutocomple{::g::Fuse::Scripting::NativeModule_type* PlaceAutocompleModule_typeof();}}}
namespace g{namespace Experimental{namespace Http{uType* BinaryLoader_typeof();}}}
...
void uInitRtti()
{
    static uType*(*factories[])() =
    {
        ...
        (uType*(*)())&::g::fuseplaceautocomplete_FuseControlsTextControl_Value_Property_typeof,
        (uType*(*)())&::g::fuseplaceautocomplete_FuseReactiveEach_Items_Property_typeof,
        ...
        (uType*(*)())&::g::Uno::Platform::AndroidDisplay_typeof,
        ...
        (uType*(*)())&::g::Android::ActivityUtils_typeof,
        ...
        (uType*(*)())&::g::Fuse::PreviewStateData__Entry_typeof,
        ...
        (uType*(*)())&::g::Fuse::PreviewState_typeof,
        (uType*(*)())&::g::Fuse::PreviewStateData_typeof,
        ...
        (uType*(*)())&::g::Fuse::Resources::Exif::ExifAndroidImpl_typeof,
        (uType*(*)())&::g::Fuse::Resources::Exif::ExifData_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::Observable__Subscription__ClearExclusiveOperation_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ThreadWorker__ContextIgnoringAction_typeof,
        (uType*(*)())&::g::Fuse::Scripting::DateTimeConverterHelpers_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::Observable__Failed_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::FunctionMirror_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ThreadWorker__MethodClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Module_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ModuleInstance_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::ThreadWorker__PropertyClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ObservableProperty__PushCapture_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ThreadWorker__ReadonlyPropertyClosure_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Observable__RemoveAt_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Observable__RemoveRange_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Observable__Subscription__ReplaceAllExclusiveOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ScriptModule__RequireContext_typeof,
        (uType*(*)())&::g::Fuse::Scripting::RootableScriptModule_typeof,
        ...
        (uType*(*)())&::g::Fuse::Scripting::Observable__Subscription__SetExclusiveOperation_typeof,
        (uType*(*)())&::g::Fuse::Scripting::StringChangedArgs_typeof,
        (uType*(*)())&::g::Fuse::Scripting::Observable__Subscription_typeof,
        (uType*(*)())&::g::Fuse::Scripting::SubscriptionSubject_typeof,
        (uType*(*)())&::g::Fuse::Scripting::ThreadWorker_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::TextEditRenderer__Renderer_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::TreeRenderer__ViewGroup_typeof,
        ...
        (uType*(*)())&::g::Fuse::Controls::Native::Android::CanvasViewGroup_typeof,
        ...
        (uType*(*)())&::g::Fuse::Drawing::AndroidCanvasPath_typeof,
        (uType*(*)())&::g::Fuse::Drawing::AndroidGraphicsDrawHelper_typeof,
        (uType*(*)())&::g::Fuse::Drawing::AndroidSurface_typeof,
        ...
        (uType*(*)())&::g::Fuse::Navigation::RouterPageRoute_typeof,
        ...
        (uType*(*)())&::g::Fuse::PlaceAutocomple::Launch_typeof,
        (uType*(*)())&::g::Fuse::PlaceAutocomple::PlaceAutocompleModule_typeof,
